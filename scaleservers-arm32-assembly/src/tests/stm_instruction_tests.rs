...
fn encode__stm_t1() {
    // STM r7!, {r0, r2, r4, r6}
    let instruction = ArmT32Instruction::Stm_T1(
        Arm32LowGeneralPurposeRegister::R7,
        vec![
    ...
    assert_eq!(encoded_instruction, vec![0x55, 0xC7]);
}

#[test]
fn decode__stm_t1() {
    // STM r7!, {r0, r2, r4, r6}
    let encoded_instruction = [0x55, 0xC7];
    let verify_instruction = ArmT32Instruction::Stm_T1(
        Arm32LowGeneralPurposeRegister::R7,
        vec![
            Arm32LowGeneralPurposeRegister::R0,
            Arm32LowGeneralPurposeRegister::R2,
