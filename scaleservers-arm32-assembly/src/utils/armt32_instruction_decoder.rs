...
impl ArmT32InstructionDecoder {
    pub fn decode_instruction_halfword__0002__0305(instruction_halfword: u16) -> (/*u3*/u8, /*u3*/u8) {
    ...
    pub fn decode_instruction_halfword__0002__0305__0608(instruction_halfword: u16) -> (/*u3*/u8, /*u3*/u8, /*u3*/u8) {
        let val0 = (instruction_halfword & 0b0000_0111) as u8;
        let val1 = ((instruction_halfword >> 3) & 0b0000_0111) as u8;
    ...
    pub fn decode_instruction_halfword__0002__0305__060a(instruction_halfword: u16) -> (/*u3*/u8, /*u3*/u8, /*u5*/u8) {
        let val0 = (instruction_halfword & 0b0000_0111) as u8;
        let val1 = ((instruction_halfword >> 3) & 0b0000_0111) as u8;
    ...
    pub fn decode_instruction_halfword__0002__0306__0707(instruction_halfword: u16) -> (/*u3*/u8, /*u4*/u8, /*u1*/u8) {
        let val0 = (instruction_halfword & 0b0000_0111) as u8;
    ...
    pub fn decode_instruction_halfword__0002__0707(instruction_halfword: u16) -> (/*u3*/u8, /*u1*/u8) {
        let val0 = (instruction_halfword & 0b0000_0111) as u8;
    ...
    pub fn decode_instruction_halfword__0006(instruction_halfword: u16) -> /*u7*/u8 {
        

        (instruction_halfword & 0b0111_1111) as u8
    }

    pub fn decode_instruction_halfword__0007(instruction_halfword: u16) -> /*u8*/u8 {
        

        (instruction_halfword & 0b1111_1111) as u8
    }

    pub fn decode_instruction_halfword__0007__0808(instruction_halfword: u16) -> (/*u8*/u8, /*u1*/u8) {
    ...
    pub fn decode_instruction_halfword__0007__080a(instruction_halfword: u16) -> (/*u8*/u8, /*u3*/u8) {
        let val0 = (instruction_halfword & 0b1111_1111) as u8;
    ...
    pub fn decode_instruction_halfword__s0007__080b(instruction_halfword: u16) -> (/*i8*/i8, /*u4*/u8) {
    ...
    pub fn decode_instruction_halfword__s000a(instruction_halfword: u16) -> /*i11*/i16 {
    ...
    pub fn decode_instruction_halfword__0306(instruction_halfword: u16) -> /*u4*/u8 {
        

        ((instruction_halfword >> 3) & 0b0000_1111) as u8
    }

    pub fn decode_instruction_halfword__0404(instruction_halfword: u16) -> /*u1*/u8 {
    ...
    pub fn decode_instruction_word__0003(instruction_word: u32) -> /*u4*/u8 {
    ...
    pub fn decode_instruction_word__000a__0b0b__0d0d__1019__1a1a(instruction_word: u32) -> (/*u11*/u16, /*u1*/u8, /*u1*/u8, /*u10*/u16, /*u1*/u8) {
