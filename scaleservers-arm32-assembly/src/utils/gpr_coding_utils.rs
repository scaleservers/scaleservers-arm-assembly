...
pub fn convert_gpr_register_list_u8_and_m_u1_to_registers_vector(
    register_list: u8,
    m: /*u1*/ u8,
) -> Vec<Arm32GeneralPurposeRegister> {
...
pub fn convert_gpr_register_list_u8_and_p_u1_to_registers_vector(
    register_list: u8,
    p: /*u1*/ u8,
) -> Vec<Arm32GeneralPurposeRegister> {
    let mut result = convert_gpr_register_list_u8_to_registers_vector(register_list);
...
pub fn convert_gpr_register_list_u8_to_low_registers_vector(
    register_list: u8,
) -> Vec<Arm32LowGeneralPurposeRegister> {
...
pub fn convert_gpr_register_list_u8_to_registers_vector(
    register_list: u8,
) -> Vec<Arm32GeneralPurposeRegister> {
...
pub fn convert_gpr_register_list_u16_to_registers_vector(
    register_list: u16,
) -> Vec<Arm32GeneralPurposeRegister> {
    let mut result = Vec::<Arm32GeneralPurposeRegister>::new();
    for i in 0..=15 {
...
pub fn convert_registers_slice_to_gpr_register_list_u8_and_p_u1(
    registers: &[Arm32GeneralPurposeRegister],
) -> Result<(/*register_list: */ u8, /*p: u1*/ u8), EncodeError> {
        ...
        match register_as_operand_bits {
            ...
            _ => {
                return Err(EncodeError::RegisterNotEncodable {
                    field: "registers",
                    detail: "a POP register list may only contain R0-R7 and PC (R15)",
                });
            }
        }
    }
...
pub fn convert_registers_slice_to_gpr_register_list_u8_and_m_u1(
    registers: &[Arm32GeneralPurposeRegister],
) -> Result<(/*register_list: */ u8, /*m: u1*/ u8), EncodeError> {
    for register in registers {
        let register_as_operand_bits = register.as_operand_bits();
        match register_as_operand_bits {
            0..=7 | 14 => {
...
pub fn convert_low_registers_slice_to_gpr_register_list_u8(
    registers: &[Arm32LowGeneralPurposeRegister],
    ...
    for register in registers {
        ...
        match register_as_operand_bits {
            ...
            _ => {
                return Err(EncodeError::RegisterNotEncodable {
                    field: "registers",
                    detail: "this register list may only contain R0-R7",
                });
            }
        }
...
pub fn convert_registers_slice_to_gpr_register_list_u16(
    registers: &[Arm32GeneralPurposeRegister],
    ...
    for register in registers {
        ...
        match register_as_operand_bits {
            ...
            _ => {
                ...
                return Err(EncodeError::RegisterNotEncodable {
                    field: "registers",
                    detail: "register out of range R0-R15",
                });
            }
        }
