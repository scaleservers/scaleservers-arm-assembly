...
use crate::enums::{
    ...
    Arm32LowGeneralPurposeRegister, Arm32MveBitwiseOp, Arm32MveFloatArithOp, Arm32MveFloatReduceOp,
    Arm32MveFloatSize, Arm32MveIntArithOp, Arm32MveLongMacOp, Arm32MveMisc2FloatOp,
    Arm32MveMisc2Op, Arm32MveQMovnKind, Arm32MveReduceOp, Arm32MveShiftImmOp,
    Arm32MveShiftNarrowOp, Arm32MveSize, Arm32MveVcmpCondition, Arm32MveVecScalarFloatOp,
    Arm32MveVecScalarIntOp, Arm32MveVectorRegister, Arm32MveVrintOp, Arm32SinglePrecisionRegister,
    Arm32VmovLaneSize, ArmT32CpsPrimaskEffect, ArmT32FpDataOperation2, ArmT32FpDataOperation3,
    ArmT32IndexMode, ArmT32InstructionCondition, ArmT32MemoryBarrierOption,
    ArmT32OpcodePattern_16Bit, ArmT32OpcodePattern_32Bit, ArmT32ParallelOperation,
    ArmT32ParallelPrefix, ArmT32RegisterShift, ArmT32SpecialRegister, MVE_BITWISE_SIGNATURE_MASK,
    MVE_DUALMAC_BASE, MVE_DUALMAC_MASK, MVE_FLOAT_REDUCE_SIGNATURE_MASK, MVE_FLOAT_SIGNATURE_MASK,
    MVE_GATHER_SCATTER_BASE, MVE_GATHER_SCATTER_MASK, MVE_GATHER_VBASE_BASE, MVE_GATHER_VBASE_MASK,
    MVE_INT_SIGNATURE_MASK, MVE_INTERLEAVE_BASE, MVE_INTERLEAVE_MASK, MVE_LCTP_WORD,
    MVE_LOB_DLS_BASE, MVE_LOB_DLS_MASK, MVE_LONG_DUALMAC_BASE, MVE_LONG_DUALMAC_MASK,
    MVE_MISC2_SIGNATURE_MASK, MVE_REDUCE_SIGNATURE_MASK, MVE_SHIFT_NARROW_BASE,
    MVE_SHIFT_NARROW_MASK, MVE_SHIFT_SCALAR_BASE, MVE_SHIFT_SCALAR_MASK, MVE_SHIFT_SIGNATURE_MASK,
    MVE_SHIFT_VEC_BASE, MVE_SHIFT_VEC_MASK, MVE_VABAV_BASE, MVE_VABAV_SIGNATURE_MASK,
    MVE_VADC_BASE, MVE_VADC_MASK, MVE_VADDLV_BASE, MVE_VADDLV_MASK, MVE_VBRSR_BASE, MVE_VBRSR_MASK,
    MVE_VBS_FLOAT_SIGNATURE_MASK, MVE_VBS_INT_SIGNATURE_MASK, MVE_VCADD_FLOAT_MASK,
    MVE_VCADD_FLOAT_PATTERN, MVE_VCADD_INT_MASK, MVE_VCADD_INT_PATTERN, MVE_VCMLA_MASK,
    MVE_VCMLA_PATTERN, MVE_VCMP_FLOAT_BASE, MVE_VCMP_FLOAT_MASK, MVE_VCMP_INT_BASE,
    MVE_VCMP_INT_MASK, MVE_VCMUL_MASK, MVE_VCMUL_PATTERN, MVE_VCTP_BASE, MVE_VCTP_MASK,
    MVE_VCVT_FI_BASE, MVE_VCVT_FI_FIXED_MASK, MVE_VCVT_FI_FIXED_PATTERN, MVE_VCVT_FIXED_BASE,
    MVE_VCVT_FIXED_MASK, MVE_VCVT_HALF_BASE, MVE_VCVT_HALF_MASK, MVE_VCVTR_BASE, MVE_VCVTR_MASK,
    MVE_VDUP_BASE, MVE_VDUP_MASK, MVE_VIDDUP_BASE, MVE_VIDDUP_MASK, MVE_VMOVL_BASE, MVE_VMOVL_MASK,
    MVE_VMOVN_BASE, MVE_VMOVN_MASK, MVE_VMOVX_BASE, MVE_VMOVX_MASK, MVE_VMULH_BASE, MVE_VMULH_MASK,
    ...
    mve_misc2_float_size_from_bits, mve_predicate_mask_bits, mve_predicate_mask_from_word,
...
use crate::utils::{ArmT32InstructionDecoder, ArmT32InstructionEncoder};
use crate::{ArmDecodeContext, DecodeError, EncodeError};
use alloc::vec::Vec;
...
pub enum ArmT32Instruction {
    Adc_Register_T1(
        /*rdn: u3*/ Arm32LowGeneralPurposeRegister,
        /*rm: u3*/ Arm32LowGeneralPurposeRegister,
    ),
    Add_Immediate_T1(
        /*rd: u3*/ Arm32LowGeneralPurposeRegister,
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
        /*imm3: u3*/ u8,
    ),
    Add_Immediate_T2(
        /*rdn: u3*/ Arm32LowGeneralPurposeRegister,
    ...
    Add_Register_T2(
        /*rdn: u4*/ Arm32GeneralPurposeRegister,
        /*rm: u4*/ Arm32GeneralPurposeRegister,
    ),
    Add_SpPlusImmediate_T1(
        /*rd: u3*/ Arm32LowGeneralPurposeRegister,
        /*const10: u10*/ u16,
    ),
    ...
    B_T1(
        /*cond: u4*/ ArmT32InstructionCondition,
        /*decoded_signed_imm9: i9*/ i16,
    ),
    ...
    Bkpt_T1(/*imm8: u8*/ u8),
    /// HLT -- Halting-mode debug halt (ARMv8-A, A-profile Thumb; not M-profile). 6-bit immediate.
    Hlt_T1(/*imm6: u8*/ u8),
    ...
    Cmp_Register_T2(
        /*rn: u4*/ Arm32GeneralPurposeRegister,
        /*rm: u4*/ Arm32GeneralPurposeRegister,
    ),
    Cps_T1(/*primask_effect: u1*/ ArmT32CpsPrimaskEffect),
    /// SETPAN -- Set Privileged Access Never (FEAT_PAN, ARMv8.1-A T32). The 1-bit PAN state.
    Setpan_T1(/*pan*/ bool),
    ...
    Ldm_T1(
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
        /*registers: */ Vec</*u3*/ Arm32LowGeneralPurposeRegister>,
    ),
    Ldr_Immediate_T1(
        /*rt: u3*/ Arm32LowGeneralPurposeRegister,
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
        /*decoded_imm7: u7*/ u8,
    ),
    Ldr_Immediate_T2(
        /*rt: u3*/ Arm32LowGeneralPurposeRegister,
        /*decoded_imm10: u10*/ u16,
    ),
    Ldr_Literal_T1(
        /*rt: u3*/ Arm32LowGeneralPurposeRegister,
        /*decoded_imm10: u10*/ u16,
    ...
    Mov_Register_T1(
        /*rd: u4*/ Arm32GeneralPurposeRegister,
        /*rm: u4*/ Arm32GeneralPurposeRegister,
    ),
    Mov_Register_T2(
        /*rd: u3*/ Arm32LowGeneralPurposeRegister,
    ...
    Mrs_T1(
        /*rd: u4*/ Arm32GeneralPurposeRegister,
        /*spec_reg: u8*/ ArmT32SpecialRegister,
    ),
    Msr_Register_T1(
        /*spec_reg: u8*/ ArmT32SpecialRegister,
        /*rn: u4*/ Arm32GeneralPurposeRegister,
    ...
    Mul_T1(
        /*rdm: u3*/ Arm32LowGeneralPurposeRegister,
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
    ),
    Mvn_Register_T1(
        /*rd: u3*/ Arm32LowGeneralPurposeRegister,
    ...
    Rsb_Immediate_T1(
        /*rd: u3*/ Arm32LowGeneralPurposeRegister,
        /*rn: u3*/ Arm32LowGeneralPurposeRegister, /*, imm5: u5 = 0*/
    ),
    Sbc_Register_T1(
        /*rdn: u3*/ Arm32LowGeneralPurposeRegister,
        /*rm: u3*/ Arm32LowGeneralPurposeRegister,
    ...
    Mla_T1(
        ...
        /*rn: u4*/ Arm32GeneralPurposeRegister,
        /*rm: u4*/ Arm32GeneralPurposeRegister,
        /*ra: u4*/ Arm32GeneralPurposeRegister,
    ),
    Mls_T1(
        /*rd: u4*/ Arm32GeneralPurposeRegister,
        /*rn: u4*/ Arm32GeneralPurposeRegister,
    ...
    Ldr_Immediate_T3(
        /*rt: u4*/ Arm32GeneralPurposeRegister,
        /*rn: u4*/ Arm32GeneralPurposeRegister,
        /*imm12: u12*/ u16,
    ), // LDR.W
    Str_Immediate_T3(
    ...
    Smull_T1(
        /*rdlo*/ Arm32GeneralPurposeRegister,
        /*rdhi*/ Arm32GeneralPurposeRegister,
        /*rn*/ Arm32GeneralPurposeRegister,
        /*rm*/ Arm32GeneralPurposeRegister,
    ),
    Umull_T1(
    ...
    Ldrd_Immediate_T1(
        /*rt*/ Arm32GeneralPurposeRegister,
        /*rt2*/ Arm32GeneralPurposeRegister,
        /*rn*/ Arm32GeneralPurposeRegister,
        /*offset*/ i16,
        ArmT32IndexMode,
    ),
    ...
    Ldmia_T2(
        /*rn*/ Arm32GeneralPurposeRegister,
        /*writeback*/ bool,
        /*registers*/ Vec<Arm32GeneralPurposeRegister>,
    ),
    Stmia_T2(
        /*rn*/ Arm32GeneralPurposeRegister,
        /*writeback*/ bool,
    ...
    B_T3(
        /*cond*/ ArmT32InstructionCondition,
        /*decoded_signed_imm21*/ i32,
    ),
    Cbz_T1(
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
        /*decoded_imm7: 0..=126, even*/ u8,
    ),
    Cbnz_T1(
        /*rn: u3*/ Arm32LowGeneralPurposeRegister,
        /*decoded_imm7: 0..=126, even*/ u8,
    ...
    It_T1(
        /*firstcond*/ ArmT32InstructionCondition,
        /*mask: u4, nonzero*/ u8,
    ),
    ...
    Usada8_T1(
        ...
        /*rn*/ Arm32GeneralPurposeRegister,
        /*rm*/ Arm32GeneralPurposeRegister,
        /*ra*/ Arm32GeneralPurposeRegister,
    ),
    ...
    Vldr_Single_T2(
        /*sd*/ Arm32SinglePrecisionRegister,
        /*rn*/ Arm32GeneralPurposeRegister,
        /*offset*/ i32,
    ),
    Vstr_Single_T2(
    ...
    Vldr_Double_T1(
        /*dd*/ Arm32DoublePrecisionRegister,
        /*rn*/ Arm32GeneralPurposeRegister,
        /*offset*/ i32,
    ),
    Vstr_Double_T1(
    ...
    Vldm_Single_T2(
        ...
        /*first*/ Arm32SinglePrecisionRegister,
        /*count*/ u8,
    ),
    Vstm_Single_T2(
        /*rn*/ Arm32GeneralPurposeRegister,
    ...
    FpDataProcess3_Single(
        ArmT32FpDataOperation3,
        /*sd*/ Arm32SinglePrecisionRegister,
        /*sn*/ Arm32SinglePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
    ),
    FpDataProcess3_Double(
        ArmT32FpDataOperation3,
        /*dd*/ Arm32DoublePrecisionRegister,
        /*dn*/ Arm32DoublePrecisionRegister,
        /*dm*/ Arm32DoublePrecisionRegister,
    ),
    FpDataProcess2_Single(
        ArmT32FpDataOperation2,
        /*sd*/ Arm32SinglePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
    ),
    FpDataProcess2_Double(
        ArmT32FpDataOperation2,
        /*dd*/ Arm32DoublePrecisionRegister,
        /*dm*/ Arm32DoublePrecisionRegister,
    ),
    ...
    Vmov_Core_To_Single_T1(
        /*sn*/ Arm32SinglePrecisionRegister,
        /*rt*/ Arm32GeneralPurposeRegister,
    ), // VMOV Sn, Rt
    Vmov_Single_To_Core_T1(
        /*rt*/ Arm32GeneralPurposeRegister,
        /*sn*/ Arm32SinglePrecisionRegister,
    ), // VMOV Rt, Sn
    ...
    Vcvt_FloatToInt_FromSingle_T1(
        /*sd*/ Arm32SinglePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
        /*signed*/ bool,
        /*round_to_zero*/ bool,
    ),
    Vcvt_FloatToInt_FromDouble_T1(
        /*sd*/ Arm32SinglePrecisionRegister,
        /*dm*/ Arm32DoublePrecisionRegister,
        /*signed*/ bool,
        /*round_to_zero*/ bool,
    ),
    Vcvt_IntToFloat_ToSingle_T1(
        /*sd*/ Arm32SinglePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
        /*signed*/ bool,
    ),
    Vcvt_IntToFloat_ToDouble_T1(
        /*dd*/ Arm32DoublePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
        /*signed*/ bool,
    ),
    Vcvt_Single_To_Double_T1(
        /*dd*/ Arm32DoublePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
    ),
    Vcvt_Double_To_Single_T1(
        /*sd*/ Arm32SinglePrecisionRegister,
        /*dm*/ Arm32DoublePrecisionRegister,
    ),
    ...
    MveIntArith(
        Arm32MveIntArithOp,
        Arm32MveSize,
        /*qd*/ Arm32MveVectorRegister,
        /*qn*/ Arm32MveVectorRegister,
        /*qm*/ Arm32MveVectorRegister,
    ),
    MveBitwise(
        Arm32MveBitwiseOp,
        /*qd*/ Arm32MveVectorRegister,
    ...
    MveDualMac(
        ...
        /*unsigned*/ bool,
        Arm32MveSize,
        /*rda*/ Arm32GeneralPurposeRegister,
        /*qn*/ Arm32MveVectorRegister,
        /*qm*/ Arm32MveVectorRegister,
    ),
    ...
    MveLongDualMac(
        ...
        /*unsigned*/ bool,
        Arm32MveSize,
        /*rda_lo*/ Arm32GeneralPurposeRegister,
        /*rda_hi*/ Arm32GeneralPurposeRegister,
        /*qn*/ Arm32MveVectorRegister,
        /*qm*/ Arm32MveVectorRegister,
    ),
    ...
    MveVshlc(
        /*shift*/ u8,
        /*qda*/ Arm32MveVectorRegister,
        /*rdm*/ Arm32GeneralPurposeRegister,
    ),
    ...
    MveViddup(
        ...
        /*qd*/ Arm32MveVectorRegister,
        /*rn*/ Arm32GeneralPurposeRegister,
        /*wrap_rm*/ Option<Arm32GeneralPurposeRegister>,
        /*step*/ u8,
    ),
    ...
    LongShiftImm_T1(
        /*op*/ u8,
        /*rdalo*/ Arm32GeneralPurposeRegister,
        /*rdahi*/ Arm32GeneralPurposeRegister,
        /*imm*/ u8,
    ),
    ...
    Vrint_Directed_Single_T1(
        /*mode*/ Arm32DirectedRound,
        /*sd*/ Arm32SinglePrecisionRegister,
        /*sm*/ Arm32SinglePrecisionRegister,
    ),
    /// VRINTA/N/P/M `.f64 Dd, Dm` (base `0xFEB8_0B40`).
    Vrint_Directed_Double_T1(
        /*mode*/ Arm32DirectedRound,
        /*dd*/ Arm32DoublePrecisionRegister,
        /*dm*/ Arm32DoublePrecisionRegister,
    ),
    ...
    MveVaddlv(
        /*accumulate*/ bool,
        /*unsigned*/ bool,
        /*rd_lo*/ Arm32GeneralPurposeRegister,
        /*rd_hi*/ Arm32GeneralPurposeRegister,
        /*qm*/ Arm32MveVectorRegister,
    ),
...
impl ArmT32Instruction {
    ...
    pub fn decode_with<'a, I>(
        iter: &mut I,
        iter_offset: &mut usize,
        context: &ArmDecodeContext,
        ...
        I: Iterator<Item = &'a u8>,
    {
        ...
        match halfword0 & 0b1111_1111_1100_0000 {
            opcode if opcode == ArmT32OpcodePattern_16Bit::Adc_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Adc_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::And_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::And_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Asr_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Asr_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Bic_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Bic_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Cmn_Register_T1 as u16 => {
                let (rn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Cmn_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Cmp_Register_T1 as u16 => {
                let (rn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Cmp_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Eor_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Eor_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Lsl_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Lsl_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Lsr_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Lsr_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Mul_T1 as u16 => {
                let (rdm, rn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Mul_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdm),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Mvn_Register_T1 as u16 => {
                let (rd, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Mvn_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Orr_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Orr_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Revsh_T1 as u16 => {
                let (rd, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Revsh_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Hlt_T1 as u16 => {
                // HLT #imm6 -- the imm6 is in bits[5:0], which this group's 0xFFC0 mask leaves for us to read.
                return Ok(Some(Self::Hlt_T1((halfword0 & 0b0011_1111) as u8)));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ror_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Ror_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Rsb_Immediate_T1 as u16 => {
                let (rd, rn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Rsb_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Sbc_Register_T1 as u16 => {
                let (rdn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Sbc_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Tst_Register_T1 as u16 => {
                let (rn, rm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305(halfword0);
                return Ok(Some(Self::Tst_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
        ...
        match halfword0 & 0b1111_1110_0000_0000 {
            opcode if opcode == ArmT32OpcodePattern_16Bit::Add_Immediate_T1 as u16 => {
                let (rd, rn, imm3) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305__0608(
                        halfword0,
                    );
                return Ok(Some(Self::Add_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    imm3,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Add_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Add_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldr_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldr_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ldrb_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrb_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldrh_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrh_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldrsb_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrsb_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldrsh_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrsh_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Pop_T1 as u16 => {
                let (register_list, p) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__0808(halfword0);
                let registers =
                    gpr_coding_utils::convert_gpr_register_list_u8_and_p_u1_to_registers_vector(
                        register_list,
                        p,
                    );
            ...
            op if op == ArmT32OpcodePattern_16Bit::Push_T1 as u16 => {
                let (register_list, m) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__0808(halfword0);
                let registers =
                    gpr_coding_utils::convert_gpr_register_list_u8_and_m_u1_to_registers_vector(
                        register_list,
                        m,
                    );
            ...
            op if op == ArmT32OpcodePattern_16Bit::Str_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Str_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Strb_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Strb_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Strh_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Strh_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Sub_Immediate_T1 as u16 => {
                ...
                return Ok(Some(Self::Sub_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    imm3,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Sub_Register_T1 as u16 => {
                ...
                return Ok(Some(Self::Sub_Register_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                )));
        ...
        match halfword0 & 0b1111_1000_0000_0000 {
            op if op == ArmT32OpcodePattern_16Bit::Add_Immediate_T2 as u16 => {
                let (imm8, rdn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                return Ok(Some(Self::Add_Immediate_T2(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    imm8,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Add_SpPlusImmediate_T1 as u16 => {
                ...
                return Ok(Some(Self::Add_SpPlusImmediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    const10,
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Asr_Immediate_T1 as u16 => {
                ...
                let (rd, rm, encoded_imm5) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305__060a(
                        halfword0,
                    );
                let decoded_imm5 = if encoded_imm5 == 0 { 32 } else { encoded_imm5 };
                return Ok(Some(Self::Asr_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                    decoded_imm5,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::B_T2 as u16 => {
                let encoded_signed_imm11 =
                    ArmT32InstructionDecoder::decode_instruction_halfword__s000a(halfword0);
            ...
            op if op == ArmT32OpcodePattern_16Bit::Cmp_Immediate_T1 as u16 => {
                let (imm8, rn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                return Ok(Some(Self::Cmp_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    imm8,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ldm_T1 as u16 => {
                let (register_list, rn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                let registers =
                    gpr_coding_utils::convert_gpr_register_list_u8_to_low_registers_vector(
                        register_list,
                    );
                return Ok(Some(Self::Ldm_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    registers,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ldr_Immediate_T1 as u16 => {
                let (rt, rn, encoded_imm5) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0305__060a(
                        halfword0,
                    );
                let decoded_imm7 = encoded_imm5 * 4;
                return Ok(Some(Self::Ldr_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    decoded_imm7,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldr_Immediate_T2 as u16 => {
                ...
                return Ok(Some(Self::Ldr_Immediate_T2(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    decoded_imm10,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ldr_Literal_T1 as u16 => {
                let (encoded_imm8, rt) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                let decoded_imm10 = (encoded_imm8 as u16) * 4;
                return Ok(Some(Self::Ldr_Literal_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    decoded_imm10,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Ldrb_Immediate_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrb_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    imm5,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Ldrh_Immediate_T1 as u16 => {
                ...
                return Ok(Some(Self::Ldrh_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    decoded_imm6,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Lsl_Immediate_T1 as u16 => {
                ...
                if imm5 == 0 {
                    return Ok(Some(Self::Mov_Register_T2(
                        Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                        Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                    )));
                } else {
                    return Ok(Some(Self::Lsl_Immediate_T1(
                        Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                        Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                        imm5,
                    )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Lsr_Immediate_T1 as u16 => {
                ...
                let decoded_imm5 = if encoded_imm5 == 0 { 32 } else { encoded_imm5 };
                return Ok(Some(Self::Lsr_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rm),
                    decoded_imm5,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Mov_Immediate_T1 as u16 => {
                let (imm8, rd) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                return Ok(Some(Self::Mov_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rd),
                    imm8,
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Str_Immediate_T1 as u16 => {
                ...
                let decoded_imm7 = encoded_imm5 * 4;
                return Ok(Some(Self::Str_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    decoded_imm7,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Str_Immediate_T2 as u16 => {
                let (encoded_imm8, rt) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                let decoded_imm10 = (encoded_imm8 as u16) * 4;
                return Ok(Some(Self::Str_Immediate_T2(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    decoded_imm10,
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Strb_Immediate_T1 as u16 => {
                ...
                return Ok(Some(Self::Strb_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    imm5,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Strh_Immediate_T1 as u16 => {
                ...
                let decoded_imm6 = encoded_imm5 * 2;
                return Ok(Some(Self::Strh_Immediate_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rt),
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    decoded_imm6,
                )));
            ...
            op if op == ArmT32OpcodePattern_16Bit::Sub_Immediate_T2 as u16 => {
                let (imm8, rdn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0007__080a(halfword0);
                return Ok(Some(Self::Sub_Immediate_T2(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rdn),
                    imm8,
                )));
            }
        ...
        match halfword0 & 0b1111_1111_0000_0000 {
            op if op == ArmT32OpcodePattern_16Bit::Add_Register_T2 as u16 => {
                let (rdn, rm, dn) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0306__0707(
                        halfword0,
                    );
                //
                let n = (dn << 3) | rdn;
            ...
            op if op == ArmT32OpcodePattern_16Bit::Mov_Register_T1 as u16 => {
                ...
                let rd_as_u4 = (d << 3) | rd;
                //
                return Ok(Some(Self::Mov_Register_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(rd_as_u4),
                    Arm32GeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
        ...
        match halfword0 & 0b1111_1111_0111_1000 {
            op if op == ArmT32OpcodePattern_16Bit::Add_SpPlusRegister_T1 as u16 => {
                ...
                let (rdm, dm) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__0002__0707(halfword0);
                //
                let m = (dm << 3) | rdm;
                //
                let m_as_gpr = Arm32GeneralPurposeRegister::from_operand_bits(m);
        ...
        match halfword0 & 0b1111_1111_1000_0111 {
            op if op == ArmT32OpcodePattern_16Bit::Add_SpPlusRegister_T2 as u16 => {
                ...
                return Ok(Some(Self::Add_SpPlusRegister_T2(
                    Arm32GeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Blx_Register_T1 as u16 => {
                ...
                let rm = ArmT32InstructionDecoder::decode_instruction_halfword__0306(halfword0);
                return Ok(Some(Self::Blx_Register_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            ...
            op if op == ArmT32OpcodePattern_16Bit::Bxns_T1 as u16 => {
                let rm = ArmT32InstructionDecoder::decode_instruction_halfword__0306(halfword0);
                return Ok(Some(Self::Bxns_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
            op if op == ArmT32OpcodePattern_16Bit::Blxns_T1 as u16 => {
                let rm = ArmT32InstructionDecoder::decode_instruction_halfword__0306(halfword0);
                return Ok(Some(Self::Blxns_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(rm),
                )));
            }
        ...
        match halfword0 & 0b1111_0000_0000_0000 {
            op if op == ArmT32OpcodePattern_16Bit::B_T1 as u16 => {
                let (encoded_signed_imm8, cond) =
                    ArmT32InstructionDecoder::decode_instruction_halfword__s0007__080b(halfword0);
                //
                ...
                match cond {
                    ...
                    _ => {
                        ...
                        return Ok(Some(Self::B_T1(
                            ArmT32InstructionCondition::from_operand_bits(cond),
                            decoded_signed_imm9,
                        )));
                    }
                }
        ...
        // mask: 0b1111_1111_1111_0111 (SETPAN -- the PAN immediate sits at bit 3)
        match halfword0 & 0b1111_1111_1111_0111 {
            op if op == ArmT32OpcodePattern_16Bit::Setpan_T1 as u16 => {
                return Ok(Some(Self::Setpan_T1((halfword0 >> 3) & 1 == 1)));
            }
            _ => (), // continue to next masked set
        }
        ...
        if halfword0 & 0xFF00 == 0xBF00 && (halfword0 & 0x000F) != 0 {
            ...
            return Ok(Some(Self::It_T1(
                ArmT32InstructionCondition::from_operand_bits(firstcond),
                mask,
            )));
        }
        ...
        match halfword0 & 0b1111_1101_0000_0000 {
            0xB100 => {
                let (rn, offset) = decode_halfword_compare_branch(halfword0);
                return Ok(Some(Self::Cbz_T1(
                    Arm32LowGeneralPurposeRegister::from_operand_bits(rn),
                    offset,
                )));
            }
        ...
        if !matched_first_16_bits_of_32_bit_mask {
            ...
            if leading_five_bits == 0b11101
                || leading_five_bits == 0b11110
                || leading_five_bits == 0b11111
            {
                matched_first_16_bits_of_32_bit_mask = true;
            }
        }
        ...
        if matched_first_16_bits_of_32_bit_mask {
            ...
            if word & MVE_VMOVX_MASK == MVE_VMOVX_BASE {
                let sd = Arm32SinglePrecisionRegister::from_field_and_bit(
                    (word >> 12) & 0xF,
                    (word >> 22) & 1,
                );
                let sm =
                    Arm32SinglePrecisionRegister::from_field_and_bit(word & 0xF, (word >> 5) & 1);
            ...
            if word & 0xEEBF_0ED0 == 0xEEB6_0A40 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vrintr_Double_T1(
                        Arm32DoublePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                    )
                } else {
                    Self::Vrintr_Single_T1(
                        Arm32SinglePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                    )
                }));
            }
            ...
            if word & 0xEEBF_0ED0 == 0xEEB6_0AC0 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vrintz_Double_T1(
                        Arm32DoublePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                    )
                } else {
                    Self::Vrintz_Single_T1(
                        Arm32SinglePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                    )
                }));
            ...
            if word & 0xEEBF_0ED0 == 0xEEB7_0A40 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vrintx_Double_T1(
                        Arm32DoublePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                    )
                } else {
                    Self::Vrintx_Single_T1(
                        Arm32SinglePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                    )
                }));
            ...
            if word & 0xFFBF_0FD0 == 0xEEB9_0BC0 {
                ...
                let dm =
                    Arm32DoublePrecisionRegister::from_field_and_bit(word & 0xF, (word >> 5) & 1);
            ...
            if word & 0xFFFF_FFF0 == 0xF3AF_80F0 {
                return Ok(Some(Self::Dbg_T1((word & 0xF) as u8)));
            }
            if word == 0xF3AF_8010 {
                return Ok(Some(Self::Esb_T1));
            }
            // PACBTI hints (no operands) and data-processing (PACG/AUTG/BXAUT) -- decoded before the multiplies.
            if word == 0xF3AF_800F {
                return Ok(Some(Self::PacbtiHint_T1(0)));
            } // bti
            if word == 0xF3AF_801D {
                return Ok(Some(Self::PacbtiHint_T1(1)));
            } // pac
            if word == 0xF3AF_802D {
                return Ok(Some(Self::PacbtiHint_T1(2)));
            } // aut
            if word == 0xF3AF_800D {
                return Ok(Some(Self::PacbtiHint_T1(3)));
            } // pacbti
            {
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let rn = g(((word >> 16) & 0xF) as u8);
                let rm = g((word & 0xF) as u8);
                if word & 0xFFF0_F0F0 == 0xFB60_F000 {
                    // PACG: Rd[11:8]
                    return Ok(Some(Self::PacbtiData_T1(
                        0,
                        g(((word >> 8) & 0xF) as u8),
                        rn,
                        rm,
                ...
                if word & 0xFFF0_0FF0 == 0xFB50_0F00 {
                    // AUTG: [11:8]=1111, Rd[15:12], [7:4]=0000
                    return Ok(Some(Self::PacbtiData_T1(
                        1,
                        g(((word >> 12) & 0xF) as u8),
                        rn,
                ...
                if word & 0xFFF0_0FF0 == 0xFB50_0F10 {
                    // BXAUT: [11:8]=1111, Rd[15:12], [7:4]=0001
                    return Ok(Some(Self::PacbtiData_T1(
                        2,
                        g(((word >> 12) & 0xF) as u8),
                        rn,
            ...
            if word == 0xF3BF_8F40 {
                return Ok(Some(Self::Ssbb_T1));
            }
            if word == 0xF3BF_8F44 {
                return Ok(Some(Self::Pssbb_T1));
            }
            if word == 0xF3BF_8F70 {
                return Ok(Some(Self::Sb_T1));
            }
            ...
            if word & 0xFFFF_2000 == 0xE89F_0000 {
                return Ok(Some(Self::Clrm_T1((word & 0xDFFF) as u16)));
            }
            if word & 0xFE80_0E50 == 0xFE00_0A00 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vsel_Double_T1(
                        cond,
                        Arm32DoublePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vn, n),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                    )
                } else {
                    Self::Vsel_Single_T1(
                        cond,
                        Arm32SinglePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vn, n),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                    )
                }));
            }
            ...
            if word & 0xFFBC_0ED0 == 0xFEB8_0A40 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vrint_Directed_Double_T1(
                        mode,
                        Arm32DoublePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                    )
                } else {
                    Self::Vrint_Directed_Single_T1(
                        mode,
                        Arm32SinglePrecisionRegister::from_field_and_bit(vd, d),
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                    )
            ...
            if word & 0xFFBC_0E50 == 0xFEBC_0A40 {
                ...
                return Ok(Some(if (word >> 8) & 1 == 1 {
                    Self::Vcvt_Directed_FromDouble_T1(
                        mode,
                        sd,
                        Arm32DoublePrecisionRegister::from_field_and_bit(vm, m),
                        signed,
                    ...
                    Self::Vcvt_Directed_FromSingle_T1(
                        mode,
                        sd,
                        Arm32SinglePrecisionRegister::from_field_and_bit(vm, m),
                        signed,
            ...
            if word & 0xFFF0_8F0F == 0xEA50_0F0F {
                // SQSHL/UQSHL/SRSHR/URSHR (short, immediate)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let imm = (((word >> 12) & 0b111) << 2) | ((word >> 6) & 0b11);
                return Ok(Some(Self::SatShiftImm_T1(
                    ((word >> 4) & 0b11) as u8,
                    g(((word >> 16) & 0xF) as u8),
                    imm as u8,
                )));
            }
            if word & 0xFFF0_0FDF == 0xEA50_0F0D {
                // SQRSHR/UQRSHL (short, register)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                return Ok(Some(Self::SatShiftReg_T1(
                    (word >> 5) & 1 == 1,
                    g(((word >> 16) & 0xF) as u8),
                    g(((word >> 12) & 0xF) as u8),
                )));
            }
            if word & 0xFFF1_810F == 0xEA50_010F && (word >> 4) & 0b11 != 0b11 {
                // LSLL/LSRL/ASRL (plain long, imm; [16]=0; [5:4]=11 reserved)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let rdalo = g(((word >> 16) & 0xF) as u8);
                let rdahi = g(((((word >> 9) & 0b111) << 1) | 1) as u8);
                let imm = (((word >> 12) & 0b111) << 2) | ((word >> 6) & 0b11);
                return Ok(Some(Self::LongShiftImm_T1(
                    ((word >> 4) & 0b11) as u8,
                    rdalo,
                    rdahi,
                    imm as u8,
            ...
            if word & 0xFFF1_01CF == 0xEA50_010D && (word >> 4) & 0b11 != 0b11 {
                // LSLL/LSRL/ASRL (plain long, reg; [16]=0; [5:4]=11 reserved)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let rdalo = g(((word >> 16) & 0xF) as u8);
                let rdahi = g(((((word >> 9) & 0b111) << 1) | 1) as u8);
                return Ok(Some(Self::LongShiftReg_T1(
                    ((word >> 4) & 0b11) as u8,
                    rdalo,
                    rdahi,
                    g(((word >> 12) & 0xF) as u8),
            ...
            if word & 0xFFF1_810F == 0xEA51_010F {
                // SQSHLL/UQSHLL/SRSHRL/URSHRL (long, immediate; [16]=1)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let rdalo = g((((word >> 17) & 0b111) << 1) as u8);
                let rdahi = g(((((word >> 9) & 0b111) << 1) | 1) as u8);
                let imm = (((word >> 12) & 0b111) << 2) | ((word >> 6) & 0b11);
                return Ok(Some(Self::SatShiftLongImm_T1(
                    ((word >> 4) & 0b11) as u8,
                    rdalo,
                    rdahi,
                    imm as u8,
            ...
            if word & 0xFFF1_015F == 0xEA51_010D {
                // SQRSHRL/UQRSHLL (long, register, #sat 64|48; [16]=1)
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let rdalo = g((((word >> 17) & 0b111) << 1) as u8);
                let rdahi = g(((((word >> 9) & 0b111) << 1) | 1) as u8);
                return Ok(Some(Self::SatShiftLongReg_T1(
                    (word >> 5) & 1 == 1,
                    rdalo,
                    rdahi,
                    g(((word >> 12) & 0xF) as u8),
            ...
            if word & 0b1111_1111_1111_0000_1111_0000_0011_1111
                == ArmT32OpcodePattern_32Bit::Tt_T1 as u32
            {
                let rn = ((word >> 16) & 0xF) as u8;
                let rd = ((word >> 8) & 0xF) as u8;
                return Ok(Some(Self::Tt_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(rd),
                    Arm32GeneralPurposeRegister::from_operand_bits(rn),
                    (word >> 7) & 1 == 1,
                    (word >> 6) & 1 == 1,
                )));
            }
            // VLSTM / VLLDM : Rn[19:16]
            if word & 0b1111_1111_1111_0000_1111_1111_1111_1111
                == ArmT32OpcodePattern_32Bit::Vlstm_T1 as u32
            {
                return Ok(Some(Self::Vlstm_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(((word >> 16) & 0xF) as u8),
                )));
            }
            if word & 0b1111_1111_1111_0000_1111_1111_1111_1111
                == ArmT32OpcodePattern_32Bit::Vlldm_T1 as u32
            {
                return Ok(Some(Self::Vlldm_T1(
                    Arm32GeneralPurposeRegister::from_operand_bits(((word >> 16) & 0xF) as u8),
                )));
            }
            ...
            // The three sub-families are disjoint in bits[11:8]+bit4; try float, then bitwise, then integer.
            {
                ...
                if top_byte == 0xEF || top_byte == 0xFF {
                    ...
                    if let Some(op) =
                        Arm32MveFloatArithOp::from_signature(word & MVE_FLOAT_SIGNATURE_MASK)
                    {
                    ...
                    if let Some(op) =
                        Arm32MveBitwiseOp::from_signature(word & MVE_BITWISE_SIGNATURE_MASK)
                    {
                        return Ok(Some(Self::MveBitwise(op, qd, qn, qm)));
                    }
                    // integer: element size in bits[21:20]; 0b11 is reserved (rejected by from_size_bits)
                    if let Some(op) =
                        Arm32MveIntArithOp::from_signature(word & MVE_INT_SIGNATURE_MASK)
            ...
            // is derived per direction.
            {
                ...
                if top_byte == 0xEF || top_byte == 0xFF {
                    ...
                    if let Some(size) = mve_shift_size_from_imm6(imm6)
                        && let Some(op) =
                            Arm32MveShiftImmOp::from_signature(word & MVE_SHIFT_SIGNATURE_MASK)
                    {
                        let esize = mve_shift_esize(size);
                        let amount = if op.is_left_shift() {
                            imm6 - esize
                        } else {
                            2 * esize - imm6
                        };
            ...
            if word & MVE_VCVT_FIXED_MASK == MVE_VCVT_FIXED_BASE {
                ...
                if matches!(size, Arm32MveFloatSize::F32) || imm6 >= 48 {
                    ...
                    let qd = Arm32MveVectorRegister::from_field((word >> 13) & 0b111);
                    let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                    return Ok(Some(Self::MveVcvtFixed(
                        to_fixed, unsigned, size, fbits, qd, qm,
                    )));
                }
            }
            ...
            if word & 0xFFF0_0000 == 0xFFB0_0000 {
                ...
                if let Some(op) =
                    Arm32MveMisc2FloatOp::from_signature(word & MVE_MISC2_SIGNATURE_MASK)
                ...
                && let Some(size) = Arm32MveSize::from_size_bits((word >> 20) & 0b11)
            {
                ...
                let rn = Arm32GeneralPurposeRegister::from_operand_bits(
                    (((word >> 17) & 0b111) << 1) as u8,
                );
                let qd = Arm32MveVectorRegister::from_field((word >> 13) & 0b111);
                let imm2 = (((word >> 7) & 1) << 1) | (word & 1);
                let step = (1u32 << imm2) as u8;
                let rm_field = (word >> 1) & 0b111;
                let wrap_rm = if rm_field == 0b111 {
                    None
                } else {
                    Some(Arm32GeneralPurposeRegister::from_operand_bits(
                        ((rm_field << 1) | 1) as u8,
                    ))
                };
                return Ok(Some(Self::MveViddup(
                    decrement, size, qd, rn, wrap_rm, step,
                )));
            }
            ...
            // any real VFP/VMOV word falls through to its existing decode further down.
            {
                ...
                if top_byte == 0xEE || top_byte == 0xFE {
                    ...
                    if word & MVE_VDUP_MASK == MVE_VDUP_BASE
                        && let Some(size) =
                            mve_vdup_size_from_bits((word >> 22) & 1, (word >> 5) & 1)
                    {
                        let qd = Arm32MveVectorRegister::from_field((word >> 17) & 0b111);
                        let rt = Arm32GeneralPurposeRegister::from_operand_bits(
                            ((word >> 12) & 0xF) as u8,
                        );
                    ...
                    if let Some(op) = Arm32MveVecScalarFloatOp::from_signature(
                        word & MVE_VBS_FLOAT_SIGNATURE_MASK,
                    ) {
                        let size = Arm32MveFloatSize::from_size_bit((word >> 28) & 1);
                    ...
                    if let Some(op) =
                        Arm32MveVecScalarIntOp::from_signature(word & MVE_VBS_INT_SIGNATURE_MASK)
                        && let Some(size) = Arm32MveSize::from_size_bits((word >> 20) & 0b11)
                    {
            ...
            // ---- MVE cross-lane reductions to a GPR (VADDV/VMINV/VMAXV/... and VABAV), 0xEE.. / 0xFE.. ----
            {
                ...
                if top_byte == 0xEE || top_byte == 0xFE {
                        ...
                        && let Some(size) = Arm32MveSize::from_size_bits((word >> 20) & 0b11)
                    {
                        ...
                        let rd = Arm32GeneralPurposeRegister::from_operand_bits(
                            ((word >> 12) & 0xF) as u8,
                        );
                        let qn = Arm32MveVectorRegister::from_field((word >> 17) & 0b111);
                        let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                    ...
                    if let Some(op) =
                        Arm32MveReduceOp::from_signature(word & MVE_REDUCE_SIGNATURE_MASK)
                    ...
                    if let Some(op) = Arm32MveFloatReduceOp::from_signature(
                        word & MVE_FLOAT_REDUCE_SIGNATURE_MASK,
                    ) {
                        let size = if (word >> 28) & 1 == 1 {
                            Arm32MveFloatSize::F16
                        } else {
                            Arm32MveFloatSize::F32
                        };
                    ...
                    if word & MVE_DUALMAC_MASK == MVE_DUALMAC_BASE {
                        ...
                        if let Some((unsigned, size)) = mve_dualmac_decode_size(subtract, word) {
                            ...
                            if !(unsigned && exchange) {
                                let rda = Arm32GeneralPurposeRegister::from_operand_bits(
                                    ((word >> 12) & 0xE) as u8,
                                );
                                let qn = Arm32MveVectorRegister::from_field((word >> 17) & 0b111);
                                let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                                return Ok(Some(Self::MveDualMac(
                                    subtract, exchange, accumulate, unsigned, size, rda, qn, qm,
                                )));
                            }
                        }
                    }
            ...
            // ---- MVE width-changing register moves (VMOVL long, VMOVN narrow, VADDLV reduction) ----
            {
                ...
                if top_byte == 0xEE || top_byte == 0xFE {
                    ...
                    if word & MVE_VADDLV_MASK == MVE_VADDLV_BASE {
                        let accumulate = (word >> 5) & 1 == 1;
                        let unsigned = (word >> 28) & 1 == 1;
                        let rd_lo = Arm32GeneralPurposeRegister::from_operand_bits(
                            ((word >> 12) & 0xF) as u8,
                        );
                        let rd_hi = Arm32GeneralPurposeRegister::from_operand_bits(
                            ((((word >> 20) & 0b111) << 1) | 1) as u8,
                        );
                        let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                        return Ok(Some(Self::MveVaddlv(
                            accumulate, unsigned, rd_lo, rd_hi, qm,
                        )));
                    }
                    let qd = Arm32MveVectorRegister::from_field((word >> 13) & 0b111);
                    let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                    ...
                    if word & MVE_VMOVL_MASK == MVE_VMOVL_BASE {
                        let size = if (word >> 19) & 1 == 1 {
                            Arm32MveSize::I8
                        } else {
                            Arm32MveSize::I16
                        };
                        return Ok(Some(Self::MveVmovl(
                            (word >> 12) & 1 == 1,
                            (word >> 28) & 1 == 1,
                            size,
                            qd,
            ...
            // ([0]=1), VQDMULL scalar/vector ([11:8]=1111), then VMULL poly (size==11) BEFORE VMULL integer.
            {
                ...
                if top_byte == 0xEE || top_byte == 0xFE {
                    ...
                    if word & MVE_VQDMULL_SCALAR_MASK == MVE_VQDMULL_SCALAR_BASE {
                        let rm = Arm32GeneralPurposeRegister::from_operand_bits((word & 0xF) as u8);
                        return Ok(Some(Self::MveVqdmullScalar(
                            (word >> 12) & 1 == 1,
                            (word >> 28) & 1 == 1,
                            qd,
                            qn,
                    ...
                    if word & MVE_VQDMULL_VEC_MASK == MVE_VQDMULL_VEC_BASE {
                        return Ok(Some(Self::MveVqdmull(
                            (word >> 12) & 1 == 1,
                            (word >> 28) & 1 == 1,
                            qd,
                            qn,
            ...
            // complex/predication ops below all have bit23 = 0, which this signature requires to be 1.
            {
                let top_byte = word >> 24;
                if (top_byte == 0xEE || top_byte == 0xFE)
                    && word & MVE_LONG_DUALMAC_MASK == MVE_LONG_DUALMAC_BASE
                {
                    let rda_hi_bits = (((word >> 20) & 0b111) << 1) | 1; // RdaHi is odd
                    if rda_hi_bits != 15 {
                        // r15 (PC) is not a valid accumulator
                        if let Some((op, unsigned, size)) = mve_long_dualmac_decode(word) {
                            ...
                            if !(op.rounding_high() && exchange && unsigned) {
                                let accumulate = (word >> 5) & 1 == 1;
                                let rda_lo = Arm32GeneralPurposeRegister::from_operand_bits(
                                    ((word >> 12) & 0xE) as u8,
                                );
                                let rda_hi = Arm32GeneralPurposeRegister::from_operand_bits(
                                    rda_hi_bits as u8,
                                );
                                let qn = Arm32MveVectorRegister::from_field((word >> 17) & 0b111);
                                let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                                return Ok(Some(Self::MveLongDualMac(
                                    op, exchange, accumulate, unsigned, size, rda_lo, rda_hi, qn,
                                    qm,
                                )));
                            }
                        }
            ...
            // Four mutually-exclusive gate masks; all share Qd[15:13], Qn[19:17], Qm[3:1].
            {
                ...
                if matches!(top_byte, 0xEE | 0xFE | 0xFC | 0xFD) {
                    ...
                    if word & MVE_VCVT_HALF_MASK == MVE_VCVT_HALF_BASE {
                        return Ok(Some(Self::MveVcvtHalf(
                            (word >> 12) & 1 == 1,
                            (word >> 28) & 1 == 1,
                            qd,
                            qm,
                    ...
                    if word & MVE_SHIFT_NARROW_MASK == MVE_SHIFT_NARROW_BASE
                        && let Some((op, unsigned)) = Arm32MveShiftNarrowOp::from_word(
                            (word >> 28) & 1,
                            (word >> 6) & 0b11,
                            word & 1,
                        )
                    {
                        ...
                        return Ok(Some(Self::MveShiftNarrow(
                            op,
                            unsigned,
                            (word >> 12) & 1 == 1,
                            src_is_32,
                    ...
                    if word & MVE_VSHLC_MASK == MVE_VSHLC_BASE {
                        ...
                        let rdm =
                            Arm32GeneralPurposeRegister::from_operand_bits((word & 0xF) as u8);
                    ...
                    if word & MVE_VCADD_INT_MASK == MVE_VCADD_INT_PATTERN
                        && let Some(size) = Arm32MveSize::from_size_bits((word >> 20) & 0b11)
                    {
                        return Ok(Some(Self::MveVcaddInt(
                            (word >> 28) & 1 == 0,
                            size,
                            (word >> 12) & 1 == 1,
                            qd,
                    ...
                    if word & MVE_VCADD_FLOAT_MASK == MVE_VCADD_FLOAT_PATTERN {
                        let size = if (word >> 20) & 1 == 1 {
                            Arm32MveFloatSize::F32
                        } else {
                            Arm32MveFloatSize::F16
                        };
                        return Ok(Some(Self::MveVcaddFloat(
                            size,
                            (word >> 24) & 1 == 1,
                            qd,
                            qn,
                        ...
                        && let Some(size) = Arm32MveSize::from_size_bits((word >> 20) & 0b11)
                    {
                        ...
                        let cond =
                            Arm32MveVcmpCondition::from_fc(mve_vcmp_fc_from_word(word, scalar));
                        let mask = mve_predicate_mask_from_word(word);
                        let rm = Arm32GeneralPurposeRegister::from_operand_bits((word & 0xF) as u8);
            ...
            if word & 0xF800_0001 == 0xF000_0001 {
                ...
                if boff != 0 && (hw2_top == 0b1100 || hw2_top == 0b1110) {
                    ...
                    let off17 = |imm_a: u32| {
                        sign_extension_utils::sign_extend_int_to_i32(
                            ((imm_a << 12) | (imm_b << 2) | (imm_c << 1)) as i32,
                            17,
                        )
                    };
                    if hw2_top == 0b1100 {
                    ...
                    } else if (word >> 20) & 0b111 == 0b110 {
                        // BFX (T3): hw1[6:4]=110
                        return Ok(Some(Self::Bfx_T3(boff, g(((word >> 16) & 0xF) as u8))));
                    } else if (word >> 20) & 0b111 == 0b111 {
                        // BFLX (T5): hw1[6:4]=111
                        ...
                        let off13 = sign_extension_utils::sign_extend_int_to_i32(
                            ((((word >> 16) & 0x1) << 12) | (imm_b << 2) | (imm_c << 1)) as i32,
                            13,
                        );
            ...
            if word >> 24 == 0xF0 {
                ...
                if word & 0xF000 == 0xC000 {
                    // a low-overhead-loop branch (hw1[15:12] = 1100)
                    let rn_bits = (word >> 16) & 0xF;
                    let size_field = (word >> 20) & 0b111;
                    if rn_bits == 0xF {
                        // PC marks the LE/LETP loop-end
            ...
            match word & 0b1111_1000_0000_0000_1101_0000_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Bl_T1 as u32 => {
                    ...
                    let i1 = (!(j1 ^ s)) & 0b1;
                    let i2 = (!(j2 ^ s)) & 0b1;
                    let encoded_imm24_as_u32: u32 = ((s as u32) << 23)
                        | ((i1 as u32) << 22)
                        | ((i2 as u32) << 21)
                        | ((imm10 as u32) << 11)
                        | (imm11 as u32);
                    let encoded_signed_imm24 = sign_extension_utils::sign_extend_int_to_i32(
                        encoded_imm24_as_u32 as i32,
                        24,
                    );
                    //
                ...
                0xF000_9000 => {
                    return Ok(Some(Self::B_T4(decode_word_branch_wide_unconditional(
                        word,
                    ))));
                }
            ...
            match word & 0b1111_1111_1111_1111_1111_1111_1111_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Dmb_T1 as u32 => {
                    ...
                    return Ok(Some(Self::Dmb_T1(
                        ArmT32MemoryBarrierOption::from_operand_bits(option),
                    )));
                }
                op if op == ArmT32OpcodePattern_32Bit::Dsb_T1 as u32 => {
                    // NOTE: the mask excluding the "(#)" bits is: 0b1111_1111_1111_0000_1101_0000_1111_0000
                    let option = ArmT32InstructionDecoder::decode_instruction_word__0003(word);
                    return Ok(Some(Self::Dsb_T1(
                        ArmT32MemoryBarrierOption::from_operand_bits(option),
                    )));
                }
            ...
            match word & 0b1111_1111_1111_1111_1111_0000_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Mrs_T1 as u32 => {
                    ...
                    let (sysm, rd) =
                        ArmT32InstructionDecoder::decode_instruction_word__0007__080b(word);
                    let spec_reg = ArmT32SpecialRegister::from_operand_bits(sysm);
                    return Ok(Some(Self::Mrs_T1(
                        Arm32GeneralPurposeRegister::from_operand_bits(rd),
                        spec_reg,
                    )));
                }
            ...
            match word & 0b1111_1111_1111_0000_1111_1111_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Msr_Register_T1 as u32 => {
                    // NOTE: the mask excluding the "(#)" bits is: 0b1111_1111_1110_0000_1101_0000_0000_0000
                    let (sysm, rn) =
                        ArmT32InstructionDecoder::decode_instruction_word__0007__1013(word);
                    let spec_reg = ArmT32SpecialRegister::from_operand_bits(sysm);
                    return Ok(Some(Self::Msr_Register_T1(
                        spec_reg,
                        Arm32GeneralPurposeRegister::from_operand_bits(rn),
                    )));
                }
            ...
            match word & 0b1111_1111_1111_0000_1111_0000_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Udf_T2 as u32 => {
                    let (imm12, imm4) =
                        ArmT32InstructionDecoder::decode_instruction_word__000b__1013(word);
            ...
            match word & 0b1111_1011_1111_0000_1000_0000_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Mov_Immediate_T3 as u32 => {
                    return Ok(Some(Self::Mov_Immediate_T3(
                        Arm32GeneralPurposeRegister::from_operand_bits(decode_word_rd_11_08(word)),
                        decode_word_imm16_movw(word),
                    )));
                }
                op if op == ArmT32OpcodePattern_32Bit::Movt_T1 as u32 => {
                    return Ok(Some(Self::Movt_T1(
                        Arm32GeneralPurposeRegister::from_operand_bits(decode_word_rd_11_08(word)),
                        decode_word_imm16_movw(word),
                    )));
                }
            ...
            if word & 0b1111_1010_0000_0000_1000_0000_0000_0000
                == 0b1111_0000_0000_0000_0000_0000_0000_0000
            {
                ...
                match op4 {
                    0b0000 => {
                        // AND (TST if Rd==PC, S)
                        if rd == 0b1111 && set_flags {
                            return Ok(Some(Self::Tst_Immediate_T1(rn_reg, constant)));
                        }
                        return Ok(Some(Self::And_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b0001 => {
                        return Ok(Some(Self::Bic_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b0010 => {
                        // ORR (MOV if Rn==PC)
                        if rn == 0b1111 {
                            return Ok(Some(Self::Mov_Immediate_T2(rd_reg, constant, set_flags)));
                        }
                        return Ok(Some(Self::Orr_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b0011 => {
                        // ORN (MVN if Rn==PC)
                        if rn == 0b1111 {
                            return Ok(Some(Self::Mvn_Immediate_T1(rd_reg, constant, set_flags)));
                        }
                        return Ok(Some(Self::Orn_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b0100 => {
                        // EOR (TEQ if Rd==PC, S)
                        if rd == 0b1111 && set_flags {
                            return Ok(Some(Self::Teq_Immediate_T1(rn_reg, constant)));
                        }
                        return Ok(Some(Self::Eor_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b1000 => {
                        // ADD (CMN if Rd==PC, S)
                        if rd == 0b1111 && set_flags {
                            return Ok(Some(Self::Cmn_Immediate_T1(rn_reg, constant)));
                        }
                        return Ok(Some(Self::Add_Immediate_T3(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b1010 => {
                        return Ok(Some(Self::Adc_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b1011 => {
                        return Ok(Some(Self::Sbc_Immediate_T1(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b1101 => {
                        // SUB (CMP if Rd==PC, S)
                        if rd == 0b1111 && set_flags {
                            return Ok(Some(Self::Cmp_Immediate_T2(rn_reg, constant)));
                        }
                        return Ok(Some(Self::Sub_Immediate_T3(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
                    0b1110 => {
                        return Ok(Some(Self::Rsb_Immediate_T2(
                            rd_reg, rn_reg, constant, set_flags,
                        )));
                    }
            ...
            if word & 0b1111_1110_0000_0000_1000_0000_0000_0000
                == 0b1110_1010_0000_0000_0000_0000_0000_0000
            {
                let op4 = (word >> 21) & 0b1111;
                let set_flags = ((word >> 20) & 0b1) == 1;
                let rn = ((word >> 16) & 0b1111) as u8;
                ...
                match op4 {
                    0b0000 => {
                        return Ok(Some(if rd_pc_set {
                            Self::Tst_Register_T2(rn_reg, rm_reg, shift)
                        } else {
                            Self::And_Register_T2(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b0001 => {
                        return Ok(Some(Self::Bic_Register_T2(
                            rd_reg, rn_reg, rm_reg, shift, set_flags,
                        )));
                    }
                    0b0010 => {
                        return Ok(Some(if rn_is_pc {
                            Self::Mov_Register_T3(rd_reg, rm_reg, shift, set_flags)
                        } else {
                            Self::Orr_Register_T2(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b0011 => {
                        return Ok(Some(if rn_is_pc {
                            Self::Mvn_Register_T2(rd_reg, rm_reg, shift, set_flags)
                        } else {
                            Self::Orn_Register_T1(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b0100 => {
                        return Ok(Some(if rd_pc_set {
                            Self::Teq_Register_T1(rn_reg, rm_reg, shift)
                        } else {
                            Self::Eor_Register_T2(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b1000 => {
                        return Ok(Some(if rd_pc_set {
                            Self::Cmn_Register_T2(rn_reg, rm_reg, shift)
                        } else {
                            Self::Add_Register_T3(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b1010 => {
                        return Ok(Some(Self::Adc_Register_T2(
                            rd_reg, rn_reg, rm_reg, shift, set_flags,
                        )));
                    }
                    0b1011 => {
                        return Ok(Some(Self::Sbc_Register_T2(
                            rd_reg, rn_reg, rm_reg, shift, set_flags,
                        )));
                    }
                    0b1101 => {
                        return Ok(Some(if rd_pc_set {
                            Self::Cmp_Register_T3(rn_reg, rm_reg, shift)
                        } else {
                            Self::Sub_Register_T2(rd_reg, rn_reg, rm_reg, shift, set_flags)
                        }));
                    }
                    0b1110 => {
                        return Ok(Some(Self::Rsb_Register_T1(
                            rd_reg, rn_reg, rm_reg, shift, set_flags,
                        )));
                    }
            ...
            if word & 0b1111_1111_1110_0000_1000_0000_0001_0000 == 0xEAC0_0000 {
                ...
                return Ok(Some(if tb {
                    Self::Pkhtb_T1(g(rd), g(rn), g(rm), amount)
                } else {
                    Self::Pkhbt_T1(g(rd), g(rn), g(rm), amount)
                }));
            }
            ...
            match word & 0b1111_1111_1111_0000_1111_0000_1111_0000 {
                ...
                0xFA90_F080 => {
                    let rd = decode_word_rd_11_08(word);
                    return Ok(Some(Self::Rev_T2(g(rd), g((word & 0b1111) as u8))));
                }
                0xFA90_F090 => {
                    let rd = decode_word_rd_11_08(word);
                    return Ok(Some(Self::Rev16_T2(g(rd), g((word & 0b1111) as u8))));
                }
                0xFA90_F0B0 => {
                    let rd = decode_word_rd_11_08(word);
                    return Ok(Some(Self::Revsh_T2(g(rd), g((word & 0b1111) as u8))));
                }
                // M8a DSP saturating arithmetic (Rn 19:16, Rd 11:8, Rm 3:0)
                0xFA80_F080 => {
                    let (rn, rd, rm) = decode_word_rn_rd_rm(word);
                    return Ok(Some(Self::Qadd_T1(g(rd), g(rm), g(rn))));
                }
                0xFA80_F0A0 => {
                    let (rn, rd, rm) = decode_word_rn_rd_rm(word);
                    return Ok(Some(Self::Qsub_T1(g(rd), g(rm), g(rn))));
                }
                0xFA80_F090 => {
                    let (rn, rd, rm) = decode_word_rn_rd_rm(word);
                    return Ok(Some(Self::Qdadd_T1(g(rd), g(rm), g(rn))));
                }
                0xFA80_F0B0 => {
                    let (rn, rd, rm) = decode_word_rn_rd_rm(word);
                    return Ok(Some(Self::Qdsub_T1(g(rd), g(rm), g(rn))));
                }
                // M8c DSP SEL (Rd, Rn, Rm)
                0xFAA0_F080 => {
                    let (rn, rd, rm) = decode_word_rn_rd_rm(word);
                    return Ok(Some(Self::Sel_T1(g(rd), g(rn), g(rm))));
                }
                _ => (),
            }
            ...
            if word & 0b1111_1111_1000_0000_1111_0000_1000_0000 == 0xFA80_F000 {
                ...
                if let (Some(operation), Some(prefix)) = (operation, prefix) {
                    ...
                    let rd = ((word >> 8) & 0b1111) as u8;
                    let rm = (word & 0b1111) as u8;
                    return Ok(Some(Self::ParallelAddSub_T1(
                        operation,
                        prefix,
                        g(rd),
                        g(rn),
            ...
            match word & 0b1111_1111_1111_0000_1000_0000_0010_0000 {
                ...
                op if op == ArmT32OpcodePattern_32Bit::Bfi_T1 as u32 => {
                    ...
                    if rn == 0b1111 {
                        return Ok(Some(Self::Bfc_T1(
                            Arm32GeneralPurposeRegister::from_operand_bits(rd),
                            lsb,
                            width,
                        )));
                    } else {
                        return Ok(Some(Self::Bfi_T1(
                            Arm32GeneralPurposeRegister::from_operand_bits(rd),
                            Arm32GeneralPurposeRegister::from_operand_bits(rn),
                            lsb,
                            width,
            ...
            match word & 0b1111_1110_0101_0000_0000_0000_0000_0000 {
                0xE850_0000 => {
                    if let Some((rt, rt2, rn, off, mode)) = decode_word_load_store_dual(word) {
                        return Ok(Some(Self::Ldrd_Immediate_T1(
                            g(rt),
                            g(rt2),
                            g(rn),
                            off,
                ...
                0xE840_0000 => {
                    if let Some((rt, rt2, rn, off, mode)) = decode_word_load_store_dual(word) {
                        return Ok(Some(Self::Strd_Immediate_T1(
                            g(rt),
                            g(rt2),
                            g(rn),
                            off,
            ...
            match word & 0b1111_1111_1101_0000_0000_0000_0000_0000 {
                0xE890_0000 => {
                    let (rn, wb, regs) = decode_word_load_store_multiple(word);
                    return Ok(Some(Self::Ldmia_T2(g(rn), wb, regs)));
                }
                0xE880_0000 => {
                    let (rn, wb, regs) = decode_word_load_store_multiple(word);
                    return Ok(Some(Self::Stmia_T2(g(rn), wb, regs)));
                }
                0xE910_0000 => {
                    let (rn, wb, regs) = decode_word_load_store_multiple(word);
                    return Ok(Some(Self::Ldmdb_T1(g(rn), wb, regs)));
                }
                0xE900_0000 => {
                    let (rn, wb, regs) = decode_word_load_store_multiple(word);
                    return Ok(Some(Self::Stmdb_T1(g(rn), wb, regs)));
                }
                _ => (),
            }
                ...
                && let Some(size) = Arm32MveSize::from_size_bits((word >> 7) & 0b11)
            {
                ...
                return Ok(Some(Self::MveLoadStore(
                    is_load, size, qd, rn, offset, mode,
                )));
            }
            ...
            if matches!(word >> 24, 0xEC | 0xFC)
                && word & MVE_GATHER_SCATTER_MASK == MVE_GATHER_SCATTER_BASE
            {
                let is_load = (word >> 20) & 1 == 1;
                let unsigned = (word >> 28) & 1 == 1;
                ...
                let rn = Arm32GeneralPurposeRegister::from_operand_bits(((word >> 16) & 0xF) as u8);
                let qm = Arm32MveVectorRegister::from_field((word >> 1) & 0b111);
                return Ok(Some(Self::MveGatherScatter(
                    is_load, unsigned, esize, msize, scaled, qd, rn, qm,
                )));
            }
            ...
            if word >> 24 == 0xFD && word & MVE_GATHER_VBASE_MASK == MVE_GATHER_VBASE_BASE {
                ...
                return Ok(Some(Self::MveGatherScatterBase(
                    is_load, is_dword, writeback, qd, qn, offset,
                )));
            }

            // MVE de-interleaving/interleaving load/store (top byte 0xFC, bit12=1).
            if word >> 24 == 0xFC
                && word & MVE_INTERLEAVE_MASK == MVE_INTERLEAVE_BASE
                && let Some(size) = Arm32MveSize::from_size_bits((word >> 7) & 0b11)
            {
                let is_load = (word >> 20) & 1 == 1;
                ...
                let qd = Arm32MveVectorRegister::from_field((word >> 13) & 0b111);
                let rn = Arm32GeneralPurposeRegister::from_operand_bits(((word >> 16) & 0xF) as u8);
                return Ok(Some(Self::MveInterleave(
                    is_load, is_quad, pass, size, qd, rn, writeback,
                )));
            }
            ...
            match word & 0b1111_1111_0011_0000_0000_1111_0000_0000 {
                0xED10_0A00 => {
                    let (vf, d, rn, off) = decode_word_fp_load_store(word);
                    return Ok(Some(Self::Vldr_Single_T2(
                        Arm32SinglePrecisionRegister::from_field_and_bit(vf, d),
                        g(rn),
                        off,
                    )));
                }
                0xED00_0A00 => {
                    let (vf, d, rn, off) = decode_word_fp_load_store(word);
                    return Ok(Some(Self::Vstr_Single_T2(
                        Arm32SinglePrecisionRegister::from_field_and_bit(vf, d),
                        g(rn),
                        off,
                    )));
                ...
                0xED10_0B00 => {
                    let (vf, d, rn, off) = decode_word_fp_load_store(word);
                    return Ok(Some(Self::Vldr_Double_T1(
                        Arm32DoublePrecisionRegister::from_field_and_bit(vf, d),
                        g(rn),
                        off,
                    )));
                }
                0xED00_0B00 => {
                    let (vf, d, rn, off) = decode_word_fp_load_store(word);
                    return Ok(Some(Self::Vstr_Double_T1(
                        Arm32DoublePrecisionRegister::from_field_and_bit(vf, d),
                        g(rn),
                        off,
                    )));
            ...
            if word & 0xFFA0_0F01 == 0xED20_0B01 {
                let first = Arm32DoublePrecisionRegister::from_field_and_bit(
                    (word >> 12) & 0xF,
                    (word >> 22) & 1,
                );
                let count = (((word & 0xFF) - 1) / 2) as u8;
                return Ok(Some(Self::FldmdbxFstmdbx_T1(
                    (word >> 20) & 1 == 1,
                    g(((word >> 16) & 0xF) as u8),
                    first,
                    count,
            ...
            match word & 0b1111_1110_0001_0000_0000_1111_0000_0000 {
                0xEC10_0A00 if ((word >> 23) & 1) | ((word >> 24) & 1) == 1 => {
                    let (rn, wb, db, vf, d, imm8) = decode_word_fp_load_store_multiple(word);
                    return Ok(Some(Self::Vldm_Single_T2(
                        g(rn),
                        wb,
                        db,
                        Arm32SinglePrecisionRegister::from_field_and_bit(vf, d),
                ...
                0xEC00_0A00 if ((word >> 23) & 1) | ((word >> 24) & 1) == 1 => {
                    let (rn, wb, db, vf, d, imm8) = decode_word_fp_load_store_multiple(word);
                    return Ok(Some(Self::Vstm_Single_T2(
                        g(rn),
                        wb,
                        db,
                        Arm32SinglePrecisionRegister::from_field_and_bit(vf, d),
                ...
                0xEC10_0B00 if ((word >> 23) & 1) | ((word >> 24) & 1) == 1 => {
                    let (rn, wb, db, vf, d, imm8) = decode_word_fp_load_store_multiple(word);
                    return Ok(Some(Self::Vldm_Double_T1(
                        g(rn),
                        wb,
                        db,
                        Arm32DoublePrecisionRegister::from_field_and_bit(vf, d),
                ...
                0xEC00_0B00 if ((word >> 23) & 1) | ((word >> 24) & 1) == 1 => {
                    let (rn, wb, db, vf, d, imm8) = decode_word_fp_load_store_multiple(word);
                    return Ok(Some(Self::Vstm_Double_T1(
                        g(rn),
                        wb,
                        db,
                        Arm32DoublePrecisionRegister::from_field_and_bit(vf, d),
            ...
            match word & 0b1111_1111_1110_0000_0000_1111_1101_0000 {
                0xEC40_0A10 => {
                    ...
                    let sm = Arm32SinglePrecisionRegister::from_field_and_bit(
                        word & 0b1111,
                        (word >> 5) & 1,
                    );
                    // op (bit20): 1 = FP -> core (singles into the pair), 0 = core -> FP
                    return Ok(Some(if (word >> 20) & 1 == 1 {
                        Self::Vmov_Singles_To_CorePair_T1(g(rt), g(rt2), sm)
                    } else {
                        Self::Vmov_CorePair_To_Singles_T1(sm, g(rt), g(rt2))
                    }));
                }
                0xEC40_0B10 => {
                    let (rt2, rt) = (((word >> 16) & 0b1111) as u8, ((word >> 12) & 0b1111) as u8);
                    let dm = Arm32DoublePrecisionRegister::from_field_and_bit(
                        word & 0b1111,
                        (word >> 5) & 1,
                    );
                    return Ok(Some(if (word >> 20) & 1 == 1 {
                        Self::Vmov_Double_To_CorePair_T1(g(rt), g(rt2), dm)
                    } else {
                        Self::Vmov_CorePair_To_Double_T1(dm, g(rt), g(rt2))
                    }));
                }
                _ => (),
            }
            ...
            if word & 0b1111_1111_0000_0000_0000_1110_0001_0000 == 0xEE00_0A00 {
                ...
                if top == 1 && middle == 0b11 {
                    ...
                    if (word >> 6) & 1 == 0 {
                        ...
                        return Ok(Some(if double {
                            Self::Vmov_Immediate_Double_T1(
                                Arm32DoublePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                imm8,
                            )
                        } else {
                            Self::Vmov_Immediate_Single_T1(
                                Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                imm8,
                            )
                        }));
                    }
                    ...
                    if opc2 == 0b0010 {
                        return Ok(Some(Self::Vcvt_HalfToSingle_T1(
                            Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                            Arm32SinglePrecisionRegister::from_field_and_bit(vm_field, m_bit),
                            op7 == 1,
                        )));
                    }
                    if opc2 == 0b0011 {
                        return Ok(Some(Self::Vcvt_SingleToHalf_T1(
                            Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                            Arm32SinglePrecisionRegister::from_field_and_bit(vm_field, m_bit),
                            op7 == 1,
                        )));
                    ...
                    if opc2 & 0b1010 == 0b1010
                        && let Some((signed, bits32, frac)) = decode_word_vcvt_fixed(word)
                    {
                        let to_fixed = (opc2 >> 2) & 1 == 1;
                        return Ok(Some(match (to_fixed, double) {
                            (true, false) => Self::Vcvt_FloatToFixed_Single_T1(
                                Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                signed,
                                bits32,
                                frac,
                            ),
                            (true, true) => Self::Vcvt_FloatToFixed_Double_T1(
                                Arm32DoublePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                signed,
                                bits32,
                                frac,
                            ),
                            (false, false) => Self::Vcvt_FixedToFloat_Single_T1(
                                Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                signed,
                                bits32,
                                frac,
                            ),
                            (false, true) => Self::Vcvt_FixedToFloat_Double_T1(
                                Arm32DoublePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                signed,
                                bits32,
                                frac,
                    ...
                    if let Some(op) = ArmT32FpDataOperation2::from_bits(opc2, op7) {
                        return Ok(Some(if double {
                            Self::FpDataProcess2_Double(
                                op,
                                Arm32DoublePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                                Arm32DoublePrecisionRegister::from_field_and_bit(vm_field, m_bit),
                            )
                        } else {
                        ...
                        0b0111 => {
                            return Ok(Some(if double {
                                Self::Vcvt_Double_To_Single_T1(
                                    Arm32SinglePrecisionRegister::from_field_and_bit(
                                        vd_field, d_bit,
                                    ),
                                    Arm32DoublePrecisionRegister::from_field_and_bit(
                                        vm_field, m_bit,
                                    ),
                                )
                            } else {
                    ...
                    ArmT32FpDataOperation3::from_bits(top, middle, (word >> 6) & 1)
                {
                    ...
                    return Ok(Some(if double {
                        Self::FpDataProcess3_Double(
                            op,
                            Arm32DoublePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                            Arm32DoublePrecisionRegister::from_field_and_bit(vn_field, n_bit),
                            Arm32DoublePrecisionRegister::from_field_and_bit(vm_field, m_bit),
                        )
                    } else {
                        Self::FpDataProcess3_Single(
                            op,
                            Arm32SinglePrecisionRegister::from_field_and_bit(vd_field, d_bit),
                            Arm32SinglePrecisionRegister::from_field_and_bit(vn_field, n_bit),
                            Arm32SinglePrecisionRegister::from_field_and_bit(vm_field, m_bit),
                        )
                    }));
                }
            ...
            match word & 0b1111_1111_1111_1111_0000_1111_1111_1111 {
                ...
                0xEEE1_0A10 => {
                    return Ok(Some(Self::Vmsr_T1(g(((word >> 12) & 0b1111) as u8))));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_0000_1111_0111_1111 {
                0xEE00_0A10 => {
                    let sn = Arm32SinglePrecisionRegister::from_field_and_bit(
                        (word >> 16) & 0b1111,
                        (word >> 7) & 1,
                    );
                    return Ok(Some(Self::Vmov_Core_To_Single_T1(
                        sn,
                        g(((word >> 12) & 0b1111) as u8),
                    )));
                }
                0xEE10_0A10 => {
                    let sn = Arm32SinglePrecisionRegister::from_field_and_bit(
                    ...
                    return Ok(Some(Self::Vmov_Single_To_Core_T1(
                        g(((word >> 12) & 0b1111) as u8),
                        sn,
                    )));
                }
            ...
            if word & 0xFF90_0F1F == 0xEE00_0B10 {
                let (size, index) =
                    Arm32VmovLaneSize::from_opc_fields((word >> 21) & 0b11, (word >> 5) & 0b11);
                let dd = Arm32DoublePrecisionRegister::from_field_and_bit(
                    (word >> 16) & 0b1111,
                    (word >> 7) & 1,
                );
                return Ok(Some(Self::Vmov_Core_To_Scalar_T1(
                    size,
                    index,
                    dd,
                    g(((word >> 12) & 0b1111) as u8),
            ...
            if word & 0xFF10_0F1F == 0xEE10_0B10 {
                let (size, index) =
                    Arm32VmovLaneSize::from_opc_fields((word >> 21) & 0b11, (word >> 5) & 0b11);
                let dn = Arm32DoublePrecisionRegister::from_field_and_bit(
                    (word >> 16) & 0b1111,
                    (word >> 7) & 1,
                );
                let unsigned = !matches!(size, Arm32VmovLaneSize::Word) && (word >> 23) & 1 == 1;
                return Ok(Some(Self::Vmov_Scalar_To_Core_T1(
                    unsigned,
                    size,
                    index,
                    g(((word >> 12) & 0b1111) as u8),
            ...
            match word & 0b1111_1111_0111_1111_0000_0000_0000_0000 {
                0xF85F_0000 => {
                    let (rt, off) = decode_word_load_literal(word);
                    return Ok(Some(Self::Ldr_Literal_T2(g(rt), off)));
                }
                0xF81F_0000 => {
                    let (rt, off) = decode_word_load_literal(word);
                    return Ok(Some(Self::Ldrb_Literal_T1(g(rt), off)));
                }
                0xF83F_0000 => {
                    let (rt, off) = decode_word_load_literal(word);
                    return Ok(Some(Self::Ldrh_Literal_T1(g(rt), off)));
                }
                0xF91F_0000 => {
                    let (rt, off) = decode_word_load_literal(word);
                    return Ok(Some(Self::Ldrsb_Literal_T1(g(rt), off)));
                }
                0xF93F_0000 => {
                    let (rt, off) = decode_word_load_literal(word);
                    return Ok(Some(Self::Ldrsh_Literal_T1(g(rt), off)));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_1111_0000_0000_0000 {
                0xF890_F000 => {
                    let rn = ((word >> 16) & 0b1111) as u8;
                    return Ok(Some(Self::Pld_Immediate_T1(g(rn), (word & 0xFFF) as i32)));
                }
                0xF990_F000 => {
                    let rn = ((word >> 16) & 0b1111) as u8;
                    return Ok(Some(Self::Pli_Immediate_T1(g(rn), (word & 0xFFF) as i32)));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_1111_1111_0000_0000 {
                0xF810_FC00 => {
                    let rn = ((word >> 16) & 0b1111) as u8;
                    return Ok(Some(Self::Pld_Immediate_T1(g(rn), -((word & 0xFF) as i32))));
                }
                0xF910_FC00 => {
                    let rn = ((word >> 16) & 0b1111) as u8;
                    return Ok(Some(Self::Pli_Immediate_T1(g(rn), -((word & 0xFF) as i32))));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_0000_0000_0000_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Ldr_Immediate_T3 as u32 => {
                    ...
                    return Ok(Some(Self::Ldr_Immediate_T3(
                        Arm32GeneralPurposeRegister::from_operand_bits(rt),
                        Arm32GeneralPurposeRegister::from_operand_bits(rn),
                        imm12,
                    )));
                }
                op if op == ArmT32OpcodePattern_32Bit::Str_Immediate_T3 as u32 => {
                    let (rn, rt, imm12) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Str_Immediate_T3(
                        Arm32GeneralPurposeRegister::from_operand_bits(rt),
                        Arm32GeneralPurposeRegister::from_operand_bits(rn),
                        imm12,
                    )));
                ...
                0xF890_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Ldrb_Immediate_T2(g(rt), g(rn), i)));
                }
                0xF880_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Strb_Immediate_T2(g(rt), g(rn), i)));
                }
                0xF8B0_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Ldrh_Immediate_T2(g(rt), g(rn), i)));
                }
                0xF8A0_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Strh_Immediate_T2(g(rt), g(rn), i)));
                }
                0xF990_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Ldrsb_Immediate_T1(g(rt), g(rn), i)));
                }
                0xF9B0_0000 => {
                    let (rn, rt, i) = decode_word_rn_rt_imm12(word);
                    return Ok(Some(Self::Ldrsh_Immediate_T1(g(rt), g(rn), i)));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_0000_1111_1100_0000 {
                0xF850_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Ldr_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF840_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Str_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF810_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Ldrb_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF800_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Strb_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF830_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Ldrh_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF820_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Strh_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF910_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Ldrsb_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                0xF930_0000 => {
                    let (rn, rt, l, rm) = decode_word_rn_rt_lsl_rm(word);
                    return Ok(Some(Self::Ldrsh_Register_T2(g(rt), g(rn), g(rm), l)));
                }
                _ => (),
            }
            ...
            if word & 0xFE80_0F00 == 0xF800_0E00 {
                ...
                if size <= 2 && (!signed || (load && size < 2)) {
                    let rn =
                        Arm32GeneralPurposeRegister::from_operand_bits(((word >> 16) & 0xF) as u8);
                    let rt =
                        Arm32GeneralPurposeRegister::from_operand_bits(((word >> 12) & 0xF) as u8);
                    return Ok(Some(Self::UnprivLoadStore_T1(
                        load,
                        signed,
                        size,
                        rt,
            ...
            match word & 0b1111_1111_1111_0000_0000_1000_0000_0000 {
                0xF850_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Ldr_Immediate_T4(g(rt), g(rn), off, mode)));
                    }
                }
                0xF840_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Str_Immediate_T4(g(rt), g(rn), off, mode)));
                    }
                }
                0xF810_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Ldrb_Immediate_T3(g(rt), g(rn), off, mode)));
                    }
                }
                0xF800_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Strb_Immediate_T3(g(rt), g(rn), off, mode)));
                    }
                }
                0xF830_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Ldrh_Immediate_T3(g(rt), g(rn), off, mode)));
                    }
                }
                0xF820_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Strh_Immediate_T3(g(rt), g(rn), off, mode)));
                    }
                }
                0xF910_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Ldrsb_Immediate_T2(g(rt), g(rn), off, mode)));
                    }
                }
                0xF930_0800 => {
                    if let Some((rt, rn, off, mode)) = decode_word_load_store_indexed(word) {
                        return Ok(Some(Self::Ldrsh_Immediate_T2(g(rt), g(rn), off, mode)));
                    }
                }
                _ => (),
            }
            ...
            if word & 0xFFE0_0F80 == 0xE8C0_0F80 && (word >> 4) & 0b11 != 0b11 {
                ...
                if (word >> 20) & 1 == 1 {
                    ...
                    return Ok(Some(Self::StoreReleaseExclusive_T1(
                        size,
                        g((word & 0xF) as u8),
                        rt,
                        rn,
            ...
            match word & 0b1111_1111_1111_0000_0000_0000_1111_0000 {
                op if op == ArmT32OpcodePattern_32Bit::Mla_T1 as u32 => {
                    ...
                    return Ok(Some(Self::Mla_T1(
                        Arm32GeneralPurposeRegister::from_operand_bits(rd),
                        Arm32GeneralPurposeRegister::from_operand_bits(rn),
                        Arm32GeneralPurposeRegister::from_operand_bits(rm),
                        Arm32GeneralPurposeRegister::from_operand_bits(ra),
                    )));
                }
                op if op == ArmT32OpcodePattern_32Bit::Mls_T1 as u32 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
                    return Ok(Some(Self::Mls_T1(
                        Arm32GeneralPurposeRegister::from_operand_bits(rd),
                        Arm32GeneralPurposeRegister::from_operand_bits(rn),
                        Arm32GeneralPurposeRegister::from_operand_bits(rm),
                        Arm32GeneralPurposeRegister::from_operand_bits(ra),
                ...
                0xFB70_0000 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
                    return Ok(Some(if ra == 0b1111 {
                        Self::Usad8_T1(g(rd), g(rn), g(rm))
                    } else {
                        Self::Usada8_T1(g(rd), g(rn), g(rm), g(ra))
                    }));
                }
                _ => (),
            }
            ...
            if word & 0b1111_1111_1111_0000_0000_0000_1100_0000 == 0xFB10_0000 {
                ...
                return Ok(Some(if ra == 0b1111 {
                    Self::Smul_T1(g(rd), g(rn), g(rm), n, m)
                } else {
                    Self::Smla_T1(g(rd), g(rn), g(rm), g(ra), n, m)
                }));
            }
            ...
            match word & 0b1111_1111_1111_0000_0000_0000_1110_0000 {
                0xFB20_0000 => {
                    ...
                    let x = (word >> 4) & 1 == 1;
                    return Ok(Some(if ra == 0b1111 {
                        Self::Smuad_T1(g(rd), g(rn), g(rm), x)
                    } else {
                        Self::Smlad_T1(g(rd), g(rn), g(rm), g(ra), x)
                    }));
                }
                0xFB30_0000 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
                    let m = (word >> 4) & 1 == 1;
                    return Ok(Some(if ra == 0b1111 {
                        Self::Smulw_T1(g(rd), g(rn), g(rm), m)
                    } else {
                        Self::Smlaw_T1(g(rd), g(rn), g(rm), g(ra), m)
                    }));
                }
                0xFB40_0000 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
                    let x = (word >> 4) & 1 == 1;
                    return Ok(Some(if ra == 0b1111 {
                        Self::Smusd_T1(g(rd), g(rn), g(rm), x)
                    } else {
                        Self::Smlsd_T1(g(rd), g(rn), g(rm), g(ra), x)
                    }));
                }
                0xFB50_0000 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
                    let round = (word >> 4) & 1 == 1;
                    return Ok(Some(if ra == 0b1111 {
                        Self::Smmul_T1(g(rd), g(rn), g(rm), round)
                    } else {
                        Self::Smmla_T1(g(rd), g(rn), g(rm), g(ra), round)
                    }));
                }
                0xFB60_0000 => {
                    let (rn, ra, rd, rm) = decode_word_rn_ra_rd_rm(word);
            ...
            match word & 0b1111_1111_1111_0000_0000_0000_1111_0000 {
                0xFB80_0000 => {
                    ...
                    return Ok(Some(Self::Smull_T1(g(rl), g(rh), g(rn), g(rm))));
                }
                0xFBA0_0000 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Umull_T1(g(rl), g(rh), g(rn), g(rm))));
                }
                0xFBC0_0000 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Smlal_T1(g(rl), g(rh), g(rn), g(rm))));
                }
                0xFBE0_0000 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Umlal_T1(g(rl), g(rh), g(rn), g(rm))));
                }
                0xFBE0_0060 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Umaal_T1(g(rl), g(rh), g(rn), g(rm))));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_0000_0000_1111_0000 {
                0xFBC0_0080 | 0xFBC0_0090 | 0xFBC0_00A0 | 0xFBC0_00B0 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    let (n, m) = ((word >> 5) & 1 == 1, (word >> 4) & 1 == 1);
                    return Ok(Some(Self::Smlal_Halfword_T1(
                        g(rl),
                        g(rh),
                        g(rn),
                        g(rm),
                ...
                0xFBC0_00C0 | 0xFBC0_00D0 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Smlald_T1(
                        g(rl),
                        g(rh),
                        g(rn),
                        g(rm),
                ...
                0xFBD0_00C0 | 0xFBD0_00D0 => {
                    let (rn, rl, rh, rm) = decode_word_long_multiply(word);
                    return Ok(Some(Self::Smlsld_T1(
                        g(rl),
                        g(rh),
                        g(rn),
                        g(rm),
            ...
            match word & 0b1111_1111_1111_1111_1111_0000_1100_0000 {
                0xFA4F_F080 => {
                    let (rd, rot, rm) = decode_word_extend(word);
                    return Ok(Some(Self::Sxtb_T2(g(rd), g(rm), rot)));
                }
                0xFA5F_F080 => {
                    let (rd, rot, rm) = decode_word_extend(word);
                    return Ok(Some(Self::Uxtb_T2(g(rd), g(rm), rot)));
                }
                0xFA0F_F080 => {
                    let (rd, rot, rm) = decode_word_extend(word);
                    return Ok(Some(Self::Sxth_T2(g(rd), g(rm), rot)));
                }
                0xFA1F_F080 => {
                    let (rd, rot, rm) = decode_word_extend(word);
                    return Ok(Some(Self::Uxth_T2(g(rd), g(rm), rot)));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_1111_0000_1100_0000 {
                0xFA00_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    return Ok(Some(Self::Sxtah_T1(g(rd), g(rn), g(rm), rot)));
                }
                0xFA10_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    return Ok(Some(Self::Uxtah_T1(g(rd), g(rn), g(rm), rot)));
                }
                0xFA40_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    return Ok(Some(Self::Sxtab_T1(g(rd), g(rn), g(rm), rot)));
                }
                0xFA50_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    return Ok(Some(Self::Uxtab_T1(g(rd), g(rn), g(rm), rot)));
                }
                0xFA20_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    if rn == 0b1111 {
                        return Ok(Some(Self::Sxtb16_T1(g(rd), g(rm), rot)));
                    } else {
                        return Ok(Some(Self::Sxtab16_T1(g(rd), g(rn), g(rm), rot)));
                    }
                }
                0xFA30_F080 => {
                    let (rd, rn, rm, rot) = decode_word_extend_and_add(word);
                    if rn == 0b1111 {
                        return Ok(Some(Self::Uxtb16_T1(g(rd), g(rm), rot)));
                    } else {
                        return Ok(Some(Self::Uxtab16_T1(g(rd), g(rn), g(rm), rot)));
                    }
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1111_0000_1111_0000_1111_0000 {
                ...
                0xF3A0_0000 => {
                    let rn = ((word >> 16) & 0b1111) as u8;
                    let rd = ((word >> 8) & 0b1111) as u8;
                    return Ok(Some(Self::Usat16_T1(g(rd), (word & 0b1111) as u8, g(rn))));
                }
                _ => (),
            }
            ...
            match word & 0b1111_1111_1101_0000_1000_0000_0010_0000 {
                0xF300_0000 => {
                    let (rd, sat, rn, shift) = decode_word_saturate(word, false);
                    return Ok(Some(Self::Ssat_T1(g(rd), sat, g(rn), shift)));
                }
                0xF380_0000 => {
                    let (rd, sat, rn, shift) = decode_word_saturate(word, true);
                    return Ok(Some(Self::Usat_T1(g(rd), sat, g(rn), shift)));
                }
                _ => (),
            }
            ...
            if (word >> 25) & 0b111 == 0b111
                && context.is_cde_coprocessor(((word >> 8) & 0xF) as u8)
                && (word >> 24) & 1 == 0
            {
                let g = Arm32GeneralPurposeRegister::from_operand_bits;
                let (acc, dual, cp) = (
                ...
                if (word >> 23) & 1 == 1 {
                    ...
                    let imm = (((word >> 4) & 0x3)
                        | (((word >> 7) & 1) << 2)
                        | (((word >> 20) & 0x7) << 3)) as u8;
                    return Ok(Some(Self::Cde_Cx3_T1(
                        acc,
                        dual,
                        cp,
                        g((word & 0xF) as u8),
                    ...
                    let imm = ((word & 0x3F)
                        | (((word >> 7) & 1) << 6)
                        | (((word >> 20) & 0x3) << 7)) as u16;
                    return Ok(Some(Self::Cde_Cx2_T1(
                        acc,
                        dual,
                        cp,
                        g(((word >> 12) & 0xF) as u8),
                    ...
                    let imm = ((word & 0x3F)
                        | (((word >> 7) & 1) << 6)
                        | (((word >> 16) & 0x3F) << 7)) as u16;
                    return Ok(Some(Self::Cde_Cx1_T1(
                        acc,
                        dual,
                        cp,
                        g(((word >> 12) & 0xF) as u8),
                ...
                && context.is_cde_coprocessor(((word >> 8) & 0xF) as u8)
            {
                ...
                if word & 0xEE80_0000 == 0xEC80_0000 {
                    // VCX3 (bit23=1)
                    return Ok(Some(Self::Vcx3_T1(
                        acc,
                        kind,
                        cp,
                        vcx_dec_d(kind, word),
                        vcx_dec_hi(kind, word),
                        vcx_dec_lo(kind, word),
                        vcx_dec_imm3(word),
                    )));
                } else if word & 0xEEB0_0000 == 0xEC30_0000 {
                    // VCX2 (bit23=0, bit20=1)
                    return Ok(Some(Self::Vcx2_T1(
                        acc,
                        kind,
                        cp,
                        vcx_dec_d(kind, word),
                ...
                } else if word & 0xEEB0_0000 == 0xEC20_0000 {
                    // VCX1 (bit23=0, bit20=0)
                    return Ok(Some(Self::Vcx1_T1(
                        acc,
                        kind,
                        cp,
                        vcx_dec_d(kind, word),
            ...
            if !context.is_cde_coprocessor(cp) {
                if (top == 0xEC || top == 0xFC) && (word >> 21) & 0b111 == 0b010 {
                    // MCRR / MRRC
                    return Ok(Some(Self::Coproc_Mcrr_T1(
                        top == 0xFC,
                        (word >> 20) & 1 == 1,
                        cp,
                        ((word >> 4) & 0xF) as u8,
                ...
                if (top == 0xED || top == 0xFD) && (word >> 21) & 1 == 0 {
                    // LDC / STC (offset form: P=1, W=0)
                    let imm =
                        ((word & 0xFF) as i32) * 4 * (if (word >> 23) & 1 == 1 { 1 } else { -1 });
                    return Ok(Some(Self::Coproc_Ldc_T1(
                        top == 0xFD,
                        (word >> 22) & 1 == 1,
                        (word >> 20) & 1 == 1,
                        cp,
                ...
                if top == 0xEE || top == 0xFE {
                    ...
                    if (word >> 4) & 1 == 1 {
                        // MCR / MRC
                        return Ok(Some(Self::Coproc_Mcr_T1(
                            two,
                            (word >> 20) & 1 == 1,
                            cp,
                            ((word >> 21) & 0b111) as u8,
                        ...
                        // CDP
                        return Ok(Some(Self::Coproc_Cdp_T1(
                            two,
                            cp,
                            ((word >> 20) & 0xF) as u8,
                            ((word >> 12) & 0xF) as u8,
    ...
    pub fn encode(&self) -> Result<Vec<u8>, EncodeError> {
        let halfwords = match self {
            Self::Adc_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Adc_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Add_Immediate_T1(rd, rn, imm3) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Add_Immediate_T1,
                        rd.as_operand_bits(),
                        rn.as_operand_bits(),
                        *imm3,
                    );
            ...
            Self::Add_Immediate_T2(rdn, imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Add_Immediate_T2,
                    *imm8,
                    rdn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Add_Register_T1(rd, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Add_Register_T1,
                        rd.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Add_Register_T2(n, m) => {
                if *n == Arm32GeneralPurposeRegister::R13 {
                    return Err(EncodeError::RegisterNotEncodable {
                        field: "n",
                        detail: "n cannot be SP (R13); use Add_SpPlusRegister_T2 instead",
                    });
                }
                ...
                //
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0306__0707(
                        ArmT32OpcodePattern_16Bit::Add_Register_T2,
                        rdn_as_u3,
                        rm_as_u4,
                        dn_as_u1,
                    );
            ...
            Self::Add_SpPlusImmediate_T1(rd, const10) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Add_SpPlusImmediate_T1,
                    imm8,
                    rd.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Add_SpPlusImmediate_T2(const9) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0006(
                    ArmT32OpcodePattern_16Bit::Add_SpPlusImmediate_T2,
                    imm7,
                );
                vec![halfword0]
            }
            Self::Add_SpPlusRegister_T1(m) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0707(
                    ArmT32OpcodePattern_16Bit::Add_SpPlusRegister_T1,
                    rdm_as_u3,
                    dm_as_u1,
                );
                vec![halfword0]
            ...
            Self::Add_SpPlusRegister_T2(rm) => {
                if *rm == Arm32GeneralPurposeRegister::R13 {
                    return Err(EncodeError::RegisterNotEncodable {
                        field: "rm",
                        detail: "rm cannot be SP (R13); use Add_SpPlusRegister_T1 instead",
                    });
                }

                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0306(
                    ArmT32OpcodePattern_16Bit::Add_SpPlusRegister_T2,
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            }
            Self::Adr_T1(rd, const10) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Adr_T1,
                    imm8,
                    rd.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::And_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::And_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Asr_Immediate_T1(rd, rm, decoded_imm5) => {
                ...
                // NOTE: "A6.4.1 Shift operations" of the ARVv6-M ISA doc indicates that an imm5 value of ZERO is interpeted as an imm5 value of 32 (because shift 'type' is '10')
                let encoded_imm5 = if *decoded_imm5 == 32 {
                    0
                } else {
                    *decoded_imm5
                };
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Asr_Immediate_T1,
                        rd.as_operand_bits(),
                        rm.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Asr_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Asr_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::B_T1(cond, decoded_signed_imm9) => {
                ...
                if *cond == ArmT32InstructionCondition::AlwaysUnconditional {
                    return Err(EncodeError::ConditionNotEncodable {
                        field: "cond",
                ...
                if *cond == ArmT32InstructionCondition::Undefined(0b1111) {
                    return Err(EncodeError::ConditionNotEncodable {
                        field: "cond",
                        detail: "the 0b1111 condition is not encodable in B<c> T1; that slot is SVC",
                    });
                }
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__s080b(
                    ArmT32OpcodePattern_16Bit::B_T1,
                    encoded_signed_imm8,
                    cond.as_operand_bits(),
                );
                vec![halfword0]
            }
            Self::B_T2(decoded_signed_imm12) => {
                ...
                check_signed_range(
                    "decoded_signed_imm12",
                    *decoded_signed_imm12 as i32,
                    -2048,
                    2046,
                )?;
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__s000a(
                    ArmT32OpcodePattern_16Bit::B_T2,
                    encoded_signed_imm11,
                );
                vec![halfword0]
            }
            Self::Bic_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Bic_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Bkpt_T1(imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007(
                    ArmT32OpcodePattern_16Bit::Bkpt_T1,
                    *imm8,
                );
                vec![halfword0]
            }
            Self::Hlt_T1(imm6) => {
                // HLT #imm6 -- the 0xBA80 pattern with the 6-bit immediate in bits[5:0].
                vec![ArmT32OpcodePattern_16Bit::Hlt_T1 as u16 | ((*imm6 as u16) & 0b0011_1111)]
            }
            Self::Bl_T1(decoded_signed_imm25) => {
                check_multiple_of("decoded_signed_imm25", *decoded_signed_imm25 as i64, 2)?;
                check_signed_range(
                    "decoded_signed_imm25",
                    *decoded_signed_imm25,
                    -16_777_216,
                    16_777_214,
                )?;
                ...
                //
                let word =
                    ArmT32InstructionEncoder::encode_instruction_word__000a__0b0b__0d0d__1019__1a1a(
                        ArmT32OpcodePattern_32Bit::Bl_T1,
                        imm11,
                        j2,
                        j1,
                        imm10,
            ...
            Self::Blx_Register_T1(rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0306(
                    ArmT32OpcodePattern_16Bit::Blx_Register_T1,
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            }
            Self::Bx_T1(rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0306(
                    ArmT32OpcodePattern_16Bit::Bx_T1,
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            }
            Self::Cmn_Register_T1(rn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Cmn_Register_T1,
                    rn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Cmp_Immediate_T1(rn, imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Cmp_Immediate_T1,
                    *imm8,
                    rn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Cmp_Register_T1(rn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Cmp_Register_T1,
                    rn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Cmp_Register_T2(rn, rm) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0306__0707(
                        ArmT32OpcodePattern_16Bit::Cmp_Register_T2,
                        rn_as_u3,
                        rm_as_u4,
                        n_as_u1,
                    );
            ...
            Self::Cps_T1(primask_effect) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0404(
                    ArmT32OpcodePattern_16Bit::Cps_T1,
                    primask_effect.as_operand_bits(),
                );
                vec![halfword0]
            }
            Self::Setpan_T1(pan) => {
                // SETPAN #pan -- the 0xB610 pattern with the PAN state in bit 3.
                vec![ArmT32OpcodePattern_16Bit::Setpan_T1 as u16 | ((*pan as u16) << 3)]
            }
            Self::Dmb_T1(option) => {
                let word = ArmT32InstructionEncoder::encode_instruction_word__0003(
                    ArmT32OpcodePattern_32Bit::Dmb_T1,
                    option.as_operand_bits(),
                );
                let halfwords = split_instruction_word_into_halfwords(word);
                halfwords.to_vec()
            }
            Self::Dsb_T1(option) => {
                let word = ArmT32InstructionEncoder::encode_instruction_word__0003(
                    ArmT32OpcodePattern_32Bit::Dsb_T1,
                    option.as_operand_bits(),
                );
                let halfwords = split_instruction_word_into_halfwords(word);
                halfwords.to_vec()
            ...
            Self::Eor_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Eor_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Isb_T1(option) => {
                let word = ArmT32InstructionEncoder::encode_instruction_word__0003(
                    ArmT32OpcodePattern_32Bit::Isb_T1,
                    option.as_operand_bits(),
                );
                let halfwords = split_instruction_word_into_halfwords(word);
                halfwords.to_vec()
            ...
            Self::Ldm_T1(rn, registers) => {
                let register_list =
                    gpr_coding_utils::convert_low_registers_slice_to_gpr_register_list_u8(
                        registers,
                    )?;
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Ldm_T1,
                    register_list,
                    rn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Ldr_Immediate_T1(rt, rn, decoded_imm7) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Ldr_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Ldr_Immediate_T2(rt, decoded_imm10) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Ldr_Immediate_T2,
                    encoded_imm8,
                    rt.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Ldr_Literal_T1(rt, decoded_imm10) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Ldr_Literal_T1,
                    encoded_imm8,
                    rt.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Ldr_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Ldr_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Ldrb_Immediate_T1(rt, rn, imm5) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Ldrb_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        *imm5,
                    );
            ...
            Self::Ldrb_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Ldrb_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Ldrh_Immediate_T1(rt, rn, decoded_imm6) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Ldrh_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Ldrh_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Ldrh_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Ldrsb_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Ldrsb_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Ldrsh_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Ldrsh_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Lsl_Immediate_T1(rd, rm, imm5) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Lsl_Immediate_T1,
                        rd.as_operand_bits(),
                        rm.as_operand_bits(),
                        *imm5,
                    );
            ...
            Self::Lsl_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Lsl_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Lsr_Immediate_T1(rd, rm, decoded_imm5) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Lsr_Immediate_T1,
                        rd.as_operand_bits(),
                        rm.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Lsr_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Lsr_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Mrs_T1(rd, spec_reg) => {
                ...
                let word = ArmT32InstructionEncoder::encode_instruction_word__0007__080b(
                    ArmT32OpcodePattern_32Bit::Mrs_T1,
                    sysm,
                    rd.as_operand_bits(),
                );
                let halfwords = split_instruction_word_into_halfwords(word);
            ...
            Self::Msr_Register_T1(spec_reg, rn) => {
                let sysm = spec_reg.as_operand_bits();
                let word = ArmT32InstructionEncoder::encode_instruction_word__0007__1013(
                    ArmT32OpcodePattern_32Bit::Msr_Register_T1,
                    sysm,
                    rn.as_operand_bits(),
                );
                let halfwords = split_instruction_word_into_halfwords(word);
            ...
            Self::Mov_Immediate_T1(rd, imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Mov_Immediate_T1,
                    *imm8,
                    rd.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Mov_Register_T1(rd, rm) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0306__0707(
                        ArmT32OpcodePattern_16Bit::Mov_Register_T1,
                        rd_as_u3,
                        rm_as_u4,
                        d_as_u1,
                    );
            ...
            Self::Mul_T1(rdm, rn) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Mul_T1,
                    rdm.as_operand_bits(),
                    rn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Mvn_Register_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Mvn_Register_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Orr_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Orr_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Pop_T1(registers) => {
                let (register_list, p) =
                    gpr_coding_utils::convert_registers_slice_to_gpr_register_list_u8_and_p_u1(
                        registers,
                    )?;
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__0808(
                    ArmT32OpcodePattern_16Bit::Pop_T1,
                    register_list,
                    p,
                );
                vec![halfword0]
            ...
            Self::Push_T1(registers) => {
                let (register_list, m) =
                    gpr_coding_utils::convert_registers_slice_to_gpr_register_list_u8_and_m_u1(
                        registers,
                    )?;
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__0808(
                    ArmT32OpcodePattern_16Bit::Push_T1,
                    register_list,
                    m,
                );
                vec![halfword0]
            ...
            Self::Rev_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Rev_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Rev16_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Rev16_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Revsh_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Revsh_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Ror_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Ror_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Rsb_Immediate_T1(rd, rn) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Rsb_Immediate_T1,
                    rd.as_operand_bits(),
                    rn.as_operand_bits(), /*, imm5: 0*/
                );
                vec![halfword0]
            }
            Self::Sbc_Register_T1(rdn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Sbc_Register_T1,
                    rdn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Stm_T1(rn, registers) => {
                ...
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Stm_T1,
                    register_list,
                    rn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Str_Immediate_T1(rt, rn, decoded_imm7) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Str_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Str_Immediate_T2(rt, decoded_imm10) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Str_Immediate_T2,
                    encoded_imm8,
                    rt.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Str_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Str_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Strb_Immediate_T1(rt, rn, imm5) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Strb_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        *imm5,
                    );
            ...
            Self::Strb_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Strb_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Strh_Immediate_T1(rt, rn, decoded_imm6) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__060a(
                        ArmT32OpcodePattern_16Bit::Strh_Immediate_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        encoded_imm5,
                    );
            ...
            Self::Strh_Register_T1(rt, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Strh_Register_T1,
                        rt.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Sub_Immediate_T1(rd, rn, imm3) => {
                ...
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Sub_Immediate_T1,
                        rd.as_operand_bits(),
                        rn.as_operand_bits(),
                        *imm3,
                    );
            ...
            Self::Sub_Immediate_T2(rdn, imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007__080a(
                    ArmT32OpcodePattern_16Bit::Sub_Immediate_T2,
                    *imm8,
                    rdn.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Sub_Register_T1(rd, rn, rm) => {
                let halfword0 =
                    ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305__0608(
                        ArmT32OpcodePattern_16Bit::Sub_Register_T1,
                        rd.as_operand_bits(),
                        rn.as_operand_bits(),
                        rm.as_operand_bits(),
                    );
            ...
            Self::Sub_SpMinusImmediate_T1(const9) => {
                ...
                //
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0006(
                    ArmT32OpcodePattern_16Bit::Sub_SpMinusImmediate_T1,
                    imm7,
                );
                vec![halfword0]
            }
            Self::Svc_T1(imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007(
                    ArmT32OpcodePattern_16Bit::Svc_T1,
                    *imm8,
                );
                vec![halfword0]
            }
            Self::Sxtb_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Sxtb_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Sxth_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Sxth_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Tst_Register_T1(rn, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Tst_Register_T1,
                    rn.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Udf_T1(imm8) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0007(
                    ArmT32OpcodePattern_16Bit::Udf_T1,
                    *imm8,
                );
                vec![halfword0]
            }
            Self::Udf_T2(imm16) => {
                ...
                let word = ArmT32InstructionEncoder::encode_instruction_word__000b__1013(
                    ArmT32OpcodePattern_32Bit::Udf_T2,
                    imm12,
                    imm4,
                );
                let halfwords = split_instruction_word_into_halfwords(word);
            ...
            Self::Uxtb_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Uxtb_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Uxth_T1(rd, rm) => {
                let halfword0 = ArmT32InstructionEncoder::encode_instruction_halfword__0002__0305(
                    ArmT32OpcodePattern_16Bit::Uxth_T1,
                    rd.as_operand_bits(),
                    rm.as_operand_bits(),
                );
                vec![halfword0]
            ...
            Self::Mov_Immediate_T3(rd, imm16) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Mov_Immediate_T3 as u32
                    | movw_immediate_field_bits(*imm16)
                    | ((rd.as_operand_bits() as u32) << 8);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Movt_T1(rd, imm16) => {
                check_general_register_is_encodable("rd", rd)?;
                let word = ArmT32OpcodePattern_32Bit::Movt_T1 as u32
                    | movw_immediate_field_bits(*imm16)
                    | ((rd.as_operand_bits() as u32) << 8);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Mul_T2(rd, rn, rm) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Mul_T2 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Mla_T1(rd, rn, rm, ra) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Mla_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((ra.as_operand_bits() as u32) << 12)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Mls_T1(rd, rn, rm, ra) => {
                ...
                check_general_register_is_encodable("rm", rm)?;
                check_general_register_is_encodable("ra", ra)?;
                let word = ArmT32OpcodePattern_32Bit::Mls_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((ra.as_operand_bits() as u32) << 12)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
            ...
            Self::Sdiv_T1(rd, rn, rm) => {
                ...
                check_general_register_is_encodable("rn", rn)?;
                check_general_register_is_encodable("rm", rm)?;
                let word = ArmT32OpcodePattern_32Bit::Sdiv_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Udiv_T1(rd, rn, rm) => {
                ...
                check_general_register_is_encodable("rn", rn)?;
                check_general_register_is_encodable("rm", rm)?;
                let word = ArmT32OpcodePattern_32Bit::Udiv_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Clz_T1(rd, rm) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Clz_T1 as u32
            ...
            Self::Rbit_T1(rd, rm) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Rbit_T1 as u32
                    | ((rm.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Ubfx_T1(rd, rn, lsb, width) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Ubfx_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | bitfield_lsb_field_bits(*lsb)
                    | ((*width - 1) as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Sbfx_T1(rd, rn, lsb, width) => {
                ...
                check_general_register_is_encodable("rn", rn)?;
                check_bitfield_lsb_width(*lsb, *width)?;
                let word = ArmT32OpcodePattern_32Bit::Sbfx_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | bitfield_lsb_field_bits(*lsb)
                    | ((*width - 1) as u32);
            ...
            Self::Bfi_T1(rd, rn, lsb, width) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Bfi_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | bitfield_lsb_field_bits(*lsb)
                    | msb;
            ...
            Self::Ldr_Immediate_T3(rt, rn, imm12) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Ldr_Immediate_T3 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | (*imm12 as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Str_Immediate_T3(rt, rn, imm12) => {
                ...
                check_unsigned_maximum("imm12", *imm12 as u32, 4095)?;
                let word = ArmT32OpcodePattern_32Bit::Str_Immediate_T3 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | (*imm12 as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Ldrex_T1(rt, rn, imm) => {
                ...
                let word = ArmT32OpcodePattern_32Bit::Ldrex_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | imm8;
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Strex_T1(rd, rt, rn, imm) => {
                ...
                check_register_is_not_pc("rn", rn)?;
                let imm8 = exclusive_word_offset_field("imm", *imm)?;
                let word = ArmT32OpcodePattern_32Bit::Strex_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | imm8;
            ...
            Self::Ldrexb_T1(rt, rn) => {
                check_general_register_is_encodable("rt", rt)?;
                check_register_is_not_pc("rn", rn)?;
                let word = ArmT32OpcodePattern_32Bit::Ldrexb_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Strexb_T1(rd, rt, rn) => {
                ...
                check_general_register_is_encodable("rt", rt)?;
                check_register_is_not_pc("rn", rn)?;
                let word = ArmT32OpcodePattern_32Bit::Strexb_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | (rd.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Ldrexh_T1(rt, rn) => {
                check_general_register_is_encodable("rt", rt)?;
                check_register_is_not_pc("rn", rn)?;
                let word = ArmT32OpcodePattern_32Bit::Ldrexh_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Strexh_T1(rd, rt, rn) => {
                ...
                check_general_register_is_encodable("rt", rt)?;
                check_register_is_not_pc("rn", rn)?;
                let word = ArmT32OpcodePattern_32Bit::Strexh_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rt.as_operand_bits() as u32) << 12)
                    | (rd.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            ...
            Self::Clrex_T1 => {
                ...
                split_instruction_word_into_halfwords(
                    ArmT32OpcodePattern_32Bit::Clrex_T1 as u32 | 0b1111,
                )
                .to_vec()
            }
            Self::Tbb_T1(rn, rm) => {
                check_general_register_is_encodable("rm", rm)?;
                let word = ArmT32OpcodePattern_32Bit::Tbb_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Tbh_T1(rn, rm) => {
                check_general_register_is_encodable("rm", rm)?;
                let word = ArmT32OpcodePattern_32Bit::Tbh_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | (rm.as_operand_bits() as u32);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            ...
            Self::Mov_Immediate_T2(rd, constant, set_flags) => {
                check_general_register_is_encodable("rd", rd)?;
                let word = encode_data_processing_modified_immediate(
                    0b0010,
                    *set_flags,
                    0b1111,
                    rd.as_operand_bits(),
            ...
            Self::Add_Register_T3(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b1000, *set_flags, rd, rn, rm, shift)?
            }
            Self::Sub_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b1101, *set_flags, rd, rn, rm, shift)?
            }
            Self::And_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b0000, *set_flags, rd, rn, rm, shift)?
            }
            Self::Orr_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b0010, *set_flags, rd, rn, rm, shift)?
            }
            Self::Eor_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b0100, *set_flags, rd, rn, rm, shift)?
            }
            Self::Bic_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b0001, *set_flags, rd, rn, rm, shift)?
            }

            // ---- ARMv7-M batch M7g: shifted-register alias forms ----
            Self::Mov_Register_T3(rd, rm, shift, set_flags) => {
                encode_mov_mvn_register(0b0010, *set_flags, rd, rm, shift)?
            }
            Self::Mvn_Register_T2(rd, rm, shift, set_flags) => {
                encode_mov_mvn_register(0b0011, *set_flags, rd, rm, shift)?
            }
            Self::Adc_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b1010, *set_flags, rd, rn, rm, shift)?
            }
            Self::Sbc_Register_T2(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b1011, *set_flags, rd, rn, rm, shift)?
            }
            Self::Rsb_Register_T1(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b1110, *set_flags, rd, rn, rm, shift)?
            }
            Self::Orn_Register_T1(rd, rn, rm, shift, set_flags) => {
                encode_dp_shifted_register(0b0011, *set_flags, rd, rn, rm, shift)?
            }
            ...
            Self::Ldrb_Immediate_T2(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF890_0000, rt, rn, *imm12)?
            }
            Self::Strb_Immediate_T2(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF880_0000, rt, rn, *imm12)?
            }
            Self::Ldrh_Immediate_T2(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF8B0_0000, rt, rn, *imm12)?
            }
            Self::Strh_Immediate_T2(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF8A0_0000, rt, rn, *imm12)?
            }
            Self::Ldrsb_Immediate_T1(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF990_0000, rt, rn, *imm12)?
            }
            Self::Ldrsh_Immediate_T1(rt, rn, imm12) => {
                encode_load_store_immediate12(0xF9B0_0000, rt, rn, *imm12)?
            }
            Self::Ldr_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF850_0000, rt, rn, rm, *lsl)?
            }
            Self::Str_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF840_0000, rt, rn, rm, *lsl)?
            }
            Self::Ldrb_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF810_0000, rt, rn, rm, *lsl)?
            }
            Self::Strb_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF800_0000, rt, rn, rm, *lsl)?
            }
            Self::Ldrh_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF830_0000, rt, rn, rm, *lsl)?
            }
            Self::Strh_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF820_0000, rt, rn, rm, *lsl)?
            }
            Self::Ldrsb_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF910_0000, rt, rn, rm, *lsl)?
            }
            Self::Ldrsh_Register_T2(rt, rn, rm, lsl) => {
                encode_load_store_register(0xF930_0000, rt, rn, rm, *lsl)?
            }

            // ---- ARMv7-M batch M7k: long multiply ----
            Self::Smull_T1(rdlo, rdhi, rn, rm) => {
                encode_long_multiply(0xFB80_0000, rdlo, rdhi, rn, rm)?
            }
            Self::Umull_T1(rdlo, rdhi, rn, rm) => {
                encode_long_multiply(0xFBA0_0000, rdlo, rdhi, rn, rm)?
            }
            Self::Smlal_T1(rdlo, rdhi, rn, rm) => {
                encode_long_multiply(0xFBC0_0000, rdlo, rdhi, rn, rm)?
            }
            Self::Umlal_T1(rdlo, rdhi, rn, rm) => {
                encode_long_multiply(0xFBE0_0000, rdlo, rdhi, rn, rm)?
            }
            Self::Umaal_T1(rdlo, rdhi, rn, rm) => {
                encode_long_multiply(0xFBE0_0060, rdlo, rdhi, rn, rm)?
            }
            ...
            Self::Ssat_T1(rd, sat_imm, rn, shift) => {
                encode_saturate(0xF300_0000, false, rd, *sat_imm, rn, *shift)?
            }
            Self::Usat_T1(rd, sat_imm, rn, shift) => {
                encode_saturate(0xF380_0000, true, rd, *sat_imm, rn, *shift)?
            }

            // ---- ARMv7-M batch M7i: indexed load/store, LDRD/STRD, literal loads, preload ----
            Self::Ldr_Immediate_T4(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF850_0800, rt, rn, *offset, *mode)?
            }
            Self::Str_Immediate_T4(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF840_0800, rt, rn, *offset, *mode)?
            }
            Self::Ldrb_Immediate_T3(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF810_0800, rt, rn, *offset, *mode)?
            }
            Self::Strb_Immediate_T3(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF800_0800, rt, rn, *offset, *mode)?
            }
            Self::Ldrh_Immediate_T3(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF830_0800, rt, rn, *offset, *mode)?
            }
            Self::Strh_Immediate_T3(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF820_0800, rt, rn, *offset, *mode)?
            }
            Self::Ldrsb_Immediate_T2(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF910_0800, rt, rn, *offset, *mode)?
            }
            Self::Ldrsh_Immediate_T2(rt, rn, offset, mode) => {
                encode_load_store_indexed(0xF930_0800, rt, rn, *offset, *mode)?
            }
            Self::Ldrd_Immediate_T1(rt, rt2, rn, offset, mode) => {
                encode_load_store_dual(true, rt, rt2, rn, *offset, *mode)?
            }
            Self::Strd_Immediate_T1(rt, rt2, rn, offset, mode) => {
                encode_load_store_dual(false, rt, rt2, rn, *offset, *mode)?
            }
            ...
            Self::Pld_Immediate_T1(rn, offset) => {
                encode_preload(0xF890_F000, 0xF810_FC00, rn, *offset)?
            }
            Self::Pli_Immediate_T1(rn, offset) => {
                encode_preload(0xF990_F000, 0xF910_FC00, rn, *offset)?
            }

            // ---- ARMv7-M batch M7j: wide load/store multiple ----
            Self::Ldmia_T2(rn, writeback, registers) => {
                encode_load_store_multiple(0xE890_0000, true, rn, *writeback, registers)?
            }
            Self::Stmia_T2(rn, writeback, registers) => {
                encode_load_store_multiple(0xE880_0000, false, rn, *writeback, registers)?
            }
            Self::Ldmdb_T1(rn, writeback, registers) => {
                encode_load_store_multiple(0xE910_0000, true, rn, *writeback, registers)?
            }
            Self::Stmdb_T1(rn, writeback, registers) => {
                encode_load_store_multiple(0xE900_0000, false, rn, *writeback, registers)?
            }
            ...
            Self::It_T1(firstcond, mask) => {
                ...
                if cond_bits >= 14 {
                    return Err(EncodeError::ConditionNotEncodable {
                        field: "firstcond",
                        detail: "IT does not support the AL/NV conditions",
                    });
                }
            ...
            Self::Sxtab_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA40_F080, rd, rn, rm, *rotation)?
            }
            Self::Uxtab_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA50_F080, rd, rn, rm, *rotation)?
            }
            Self::Sxtah_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA00_F080, rd, rn, rm, *rotation)?
            }
            Self::Uxtah_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA10_F080, rd, rn, rm, *rotation)?
            }
            Self::Sxtab16_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA20_F080, rd, rn, rm, *rotation)?
            }
            Self::Uxtab16_T1(rd, rn, rm, rotation) => {
                encode_extend_and_add(0xFA30_F080, rd, rn, rm, *rotation)?
            }
            ...
            Self::Ssat16_T1(rd, sat_imm, rn) => {
                encode_saturate16(0xF320_0000, false, rd, *sat_imm, rn)?
            }
            Self::Usat16_T1(rd, sat_imm, rn) => {
                encode_saturate16(0xF3A0_0000, true, rd, *sat_imm, rn)?
            }
            ...
            Self::Smul_T1(rd, rn, rm, n, m) => {
                encode_signed_multiply(0xFB10_F000, rd, rn, rm, nm_nibble(*n, *m))?
            }
            Self::Smulw_T1(rd, rn, rm, m) => {
                encode_signed_multiply(0xFB30_F000, rd, rn, rm, *m as u32)?
            }
            Self::Smla_T1(rd, rn, rm, ra, n, m) => {
                encode_signed_multiply_accumulate(0xFB10_0000, rd, rn, rm, ra, nm_nibble(*n, *m))?
            }
            Self::Smlaw_T1(rd, rn, rm, ra, m) => {
                encode_signed_multiply_accumulate(0xFB30_0000, rd, rn, rm, ra, *m as u32)?
            }
            Self::Smlal_Halfword_T1(rdlo, rdhi, rn, rm, n, m) => encode_signed_multiply_long(
                0xFBC0_0000,
                rdlo,
                rdhi,
                rn,
                rm,
                0b1000 | nm_nibble(*n, *m),
            )?,
            Self::Smuad_T1(rd, rn, rm, x) => {
                encode_signed_multiply(0xFB20_F000, rd, rn, rm, *x as u32)?
            }
            Self::Smusd_T1(rd, rn, rm, x) => {
                encode_signed_multiply(0xFB40_F000, rd, rn, rm, *x as u32)?
            }
            Self::Smlad_T1(rd, rn, rm, ra, x) => {
                encode_signed_multiply_accumulate(0xFB20_0000, rd, rn, rm, ra, *x as u32)?
            }
            Self::Smlsd_T1(rd, rn, rm, ra, x) => {
                encode_signed_multiply_accumulate(0xFB40_0000, rd, rn, rm, ra, *x as u32)?
            }
            Self::Smlald_T1(rdlo, rdhi, rn, rm, x) => {
                encode_signed_multiply_long(0xFBC0_0000, rdlo, rdhi, rn, rm, 0b1100 | (*x as u32))?
            }
            Self::Smlsld_T1(rdlo, rdhi, rn, rm, x) => {
                encode_signed_multiply_long(0xFBD0_0000, rdlo, rdhi, rn, rm, 0b1100 | (*x as u32))?
            }
            Self::Smmul_T1(rd, rn, rm, round) => {
                encode_signed_multiply(0xFB50_F000, rd, rn, rm, *round as u32)?
            }
            Self::Smmla_T1(rd, rn, rm, ra, round) => {
                encode_signed_multiply_accumulate(0xFB50_0000, rd, rn, rm, ra, *round as u32)?
            }
            Self::Smmls_T1(rd, rn, rm, ra, round) => {
                encode_signed_multiply_accumulate(0xFB60_0000, rd, rn, rm, ra, *round as u32)?
            }

            // ---- ARMv7E-M FP M8f: load/store ----
            Self::Vldr_Single_T2(sd, rn, offset) => {
                encode_fp_load_store(0xED10_0A00, sd.field(), sd.extra_bit(), rn, *offset)?
            }
            Self::Vstr_Single_T2(sd, rn, offset) => {
                encode_fp_load_store(0xED00_0A00, sd.field(), sd.extra_bit(), rn, *offset)?
            }
            Self::Vldr_Double_T1(dd, rn, offset) => {
                encode_fp_load_store(0xED10_0B00, dd.field(), dd.extra_bit(), rn, *offset)?
            }
            Self::Vstr_Double_T1(dd, rn, offset) => {
                encode_fp_load_store(0xED00_0B00, dd.field(), dd.extra_bit(), rn, *offset)?
            }

            // ---- ARMv7E-M FP M8g: load/store multiple (single imm8=count, double imm8=2*count) ----
            Self::Vldm_Single_T2(rn, wb, db, first, count) => encode_fp_load_store_multiple(
                0x0A00,
                true,
                rn,
                *wb,
            ...
            Self::Vstm_Single_T2(rn, wb, db, first, count) => encode_fp_load_store_multiple(
                0x0A00,
                false,
                rn,
                *wb,
            ...
            Self::Vldm_Double_T1(rn, wb, db, first, count) => encode_fp_load_store_multiple(
                0x0B00,
                true,
                rn,
                *wb,
            ...
            Self::Vstm_Double_T1(rn, wb, db, first, count) => encode_fp_load_store_multiple(
                0x0B00,
                false,
                rn,
                *wb,
            ...
            Self::Coproc_Mcr_T1(two, load, cp, opc1, rt, crn, crm, opc2) => {
                split_instruction_word_into_halfwords(
                    (if *two { 0xFE00_0010u32 } else { 0xEE00_0010 })
                        | ((*load as u32) << 20)
                        | ((*opc1 as u32) << 21)
                        | ((*crn as u32) << 16)
                        | ((rt.as_operand_bits() as u32) << 12)
            ...
            Self::Coproc_Cdp_T1(two, cp, opc1, crd, crn, crm, opc2) => {
                split_instruction_word_into_halfwords(
                    (if *two { 0xFE00_0000u32 } else { 0xEE00_0000 })
                        | ((*opc1 as u32) << 20)
                        | ((*crn as u32) << 16)
                        | ((*crd as u32) << 12)
                        | ((*cp as u32) << 8)
            ...
            Self::Coproc_Mcrr_T1(two, load, cp, opc1, rt, rt2, crm) => {
                split_instruction_word_into_halfwords(
                    (if *two { 0xFC40_0000u32 } else { 0xEC40_0000 })
                        | ((*load as u32) << 20)
            ...
            Self::Coproc_Ldc_T1(two, long, load, cp, crd, rn, offset) => {
                ...
                split_instruction_word_into_halfwords(
                    (if *two { 0xFC00_0000u32 } else { 0xEC00_0000 })
                        | (1 << 24)
                        | (u << 23)
                        | ((*long as u32) << 22)
                        | ((*load as u32) << 20)
            ...
            Self::PacbtiHint_T1(kind) => split_instruction_word_into_halfwords(match kind {
                0 => 0xF3AF_800Fu32,
                1 => 0xF3AF_801D,
                2 => 0xF3AF_802D,
                _ => 0xF3AF_800D,
            ...
            Self::Vscclrm_T1(double, first, count) => {
                let (vd, d) = if *double {
                    ((*first & 0xF) as u32, (*first >> 4) as u32)
                } else {
                    ((*first >> 1) as u32, (*first & 1) as u32)
                };
                let base = if *double { 0xEC9F_0B00u32 } else { 0xEC9F_0A00 };
                split_instruction_word_into_halfwords(
                    base | (d << 22) | (vd << 12) | (*count as u32),
                )
                .to_vec()
            }
            Self::Cde_Cx1_T1(acc, dual, coproc, rd, imm) => split_instruction_word_into_halfwords(
                0xEE00_0000
                    | ((*acc as u32) << 28)
                    | ((*dual as u32) << 6)
                    | ((rd.as_operand_bits() as u32) << 12)
                    | ((*coproc as u32) << 8)
                    | ((*imm as u32) & 0x3F)
                    | ((((*imm as u32) >> 6) & 1) << 7)
                    | ((((*imm as u32) >> 7) & 0x3F) << 16),
            )
            .to_vec(),
            Self::Cde_Cx2_T1(acc, dual, coproc, rd, rn, imm) => {
                split_instruction_word_into_halfwords(
                    0xEE40_0000
                        | ((*acc as u32) << 28)
                        | ((*dual as u32) << 6)
            ...
            Self::Cde_Cx3_T1(acc, dual, coproc, rd, rn, rm, imm) => {
                split_instruction_word_into_halfwords(
                    0xEE80_0000
                        | ((*acc as u32) << 28)
                        | ((*dual as u32) << 6)
                        | ((rn.as_operand_bits() as u32) << 16)
                        | ((rm.as_operand_bits() as u32) << 12)
                        | ((*coproc as u32) << 8)
                        | (rd.as_operand_bits() as u32)
                        | (((*imm as u32) & 0x3) << 4)
                        | ((((*imm as u32) >> 2) & 1) << 7)
            ...
            Self::Bf_T1(boff, offset) => split_instruction_word_into_halfwords(
                0xF040_E001
                    | ((*boff as u32) << 23)
                    | (((*offset as u32 >> 12) & 0x1F) << 16)
                    | (((*offset as u32 >> 1) & 0x1) << 11)
            ...
            Self::Vcx1_T1(acc, kind, coproc, rd, imm) => {
                let extra = ((*acc as u32) << 28)
                    | (((*kind == 1) as u32) << 24)
                    | (((*kind == 2) as u32) << 6)
                    | ((*coproc as u32) << 8);
                split_instruction_word_into_halfwords(
                    0xEC20_0000 | extra | vcx_enc_d(*kind, *rd) | vcx_enc_imm1(*imm),
                )
                .to_vec()
            }
            ...
            Self::Vcmp_Zero_Single_T2(sd, e) => {
                let word =
                    0xEEB5_0A40 | (sd.extra_bit() << 22) | (sd.field() << 12) | ((*e as u32) << 7);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Vcmp_Zero_Double_T2(dd, e) => {
                let word =
                    0xEEB5_0B40 | (dd.extra_bit() << 22) | (dd.field() << 12) | ((*e as u32) << 7);
                split_instruction_word_into_halfwords(word).to_vec()
            }
            Self::Vmrs_T1(rt) => {
                check_general_register_is_encodable("rt", rt)?;
                split_instruction_word_into_halfwords(
                    0xEEF1_0A10 | ((rt.as_operand_bits() as u32) << 12),
                )
                .to_vec()
            }
            ...
            Self::Vmsr_T1(rt) => {
                check_general_register_is_encodable("rt", rt)?;
                split_instruction_word_into_halfwords(
                    0xEEE1_0A10 | ((rt.as_operand_bits() as u32) << 12),
                )
                .to_vec()
            }
            ...
            Self::Vmov_Core_To_Scalar_T1(size, index, dd, rt) => {
                ...
                if *index >= size.lane_count() {
                    return Err(EncodeError::ImmediateOutOfRange {
                        field: "VMOV scalar lane index",
                        value: *index as i64,
                        minimum: 0,
                        maximum: size.lane_count() as i64 - 1,
                    });
                }
            ...
            Self::Vmov_Scalar_To_Core_T1(unsigned, size, index, rt, dn) => {
                ...
                let (opc1, opc2) = size.opc_fields(*index);
                let u = if matches!(size, Arm32VmovLaneSize::Word) {
                    0
                } else {
                    *unsigned as u32
                };
            ...
            Self::Vmov_CorePair_To_Double_T1(dm, rt, rt2) => {
                encode_vmov_core_pair(0xEC40_0B10, false, rt, rt2, dm.field(), dm.extra_bit())?
            }
            Self::Vmov_Double_To_CorePair_T1(rt, rt2, dm) => {
                encode_vmov_core_pair(0xEC40_0B10, true, rt, rt2, dm.field(), dm.extra_bit())?
            }
            Self::Vmov_CorePair_To_Singles_T1(sm, rt, rt2) => {
                encode_vmov_core_pair(0xEC40_0A10, false, rt, rt2, sm.field(), sm.extra_bit())?
            }
            Self::Vmov_Singles_To_CorePair_T1(rt, rt2, sm) => {
                encode_vmov_core_pair(0xEC40_0A10, true, rt, rt2, sm.field(), sm.extra_bit())?
            }
            Self::Vcvt_HalfToSingle_T1(sd, sm, top) => {
                let word = 0xEEB2_0A40
                    | ((*top as u32) << 7)
                    | (sd.extra_bit() << 22)
                    | (sd.field() << 12)
                    | (sm.extra_bit() << 5)
            ...
            Self::Vcvt_FloatToFixed_Single_T1(sd, signed, bits32, frac) => {
                encode_vcvt_fixed(sd.field(), sd.extra_bit(), 0, true, *signed, *bits32, *frac)?
            }
            Self::Vcvt_FloatToFixed_Double_T1(dd, signed, bits32, frac) => {
                encode_vcvt_fixed(dd.field(), dd.extra_bit(), 1, true, *signed, *bits32, *frac)?
            }
            Self::Vcvt_FixedToFloat_Single_T1(sd, signed, bits32, frac) => encode_vcvt_fixed(
                sd.field(),
                sd.extra_bit(),
                0,
                false,
            ...
            Self::Vcvt_FixedToFloat_Double_T1(dd, signed, bits32, frac) => encode_vcvt_fixed(
                dd.field(),
                dd.extra_bit(),
                1,
                false,
            ...
            Self::Csdb_T1 => {
                split_instruction_word_into_halfwords(ArmT32OpcodePattern_32Bit::Csdb_T1 as u32)
                    .to_vec()
            }
            Self::Sg_T1 => {
                split_instruction_word_into_halfwords(ArmT32OpcodePattern_32Bit::Sg_T1 as u32)
                    .to_vec()
            }
            Self::Bxns_T1(rm) => vec![
                ArmT32OpcodePattern_16Bit::Bxns_T1 as u16 | ((rm.as_operand_bits() as u16) << 3),
            ],
            Self::Blxns_T1(rm) => vec![
                ArmT32OpcodePattern_16Bit::Blxns_T1 as u16 | ((rm.as_operand_bits() as u16) << 3),
            ],
            Self::Tt_T1(rd, rn, a, t) => {
                let word = ArmT32OpcodePattern_32Bit::Tt_T1 as u32
                    | ((rn.as_operand_bits() as u32) << 16)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | ((*a as u32) << 7)
                    | ((*t as u32) << 6);
            ...
            Self::Vlstm_T1(rn) => split_instruction_word_into_halfwords(
                ArmT32OpcodePattern_32Bit::Vlstm_T1 as u32 | ((rn.as_operand_bits() as u32) << 16),
            )
            .to_vec(),
            Self::Vlldm_T1(rn) => split_instruction_word_into_halfwords(
                ArmT32OpcodePattern_32Bit::Vlldm_T1 as u32 | ((rn.as_operand_bits() as u32) << 16),
            )
            .to_vec(),

            // ---- ARMv8.1-M MVE 3-reg-same vector-vector: Qn[19:17], Qd[15:13], Qm[3:1] ----
            Self::MveIntArith(op, size, qd, qn, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (size.size_bits() << 20)
                    | (qn.field() << 17)
                    | (qd.field() << 13)
            ...
            .to_vec(),
            Self::MveBitwise(op, qd, qn, qm) => split_instruction_word_into_halfwords(
                op.base_word() | (qn.field() << 17) | (qd.field() << 13) | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveFloatArith(op, size, qd, qn, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (size.size_bit() << 20)
                    | (qn.field() << 17)
                    | (qd.field() << 13)
            ...
            Self::MveVecScalarInt(op, size, qd, qn, rm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (size.size_bits() << 20)
                    | (qn.field() << 17)
                    | (qd.field() << 13)
            ...
            .to_vec(),
            Self::MveVecScalarFloat(op, size, qd, qn, rm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (size.size_bit() << 28)
                    | (qn.field() << 17)
                    | (qd.field() << 13)
            ...
            Self::MveShiftImm(op, size, amount, qd, qm) => {
                let esize = mve_shift_esize(*size);
                let imm6 = if op.is_left_shift() {
                    esize + (*amount as u32)
                } else {
                    2 * esize - (*amount as u32)
                };
                split_instruction_word_into_halfwords(
            ...
            Self::MveModifiedImmediate(cmode, op, imm8, qd) => {
                split_instruction_word_into_halfwords(encode_mve_modified_imm(
                    *cmode,
                    *op,
                    *imm8,
                    qd.field(),
            ...
            Self::MveMisc2(op, size, qd, qm) => split_instruction_word_into_halfwords(
                op.base_word() | (size.size_bits() << 18) | (qd.field() << 13) | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveMisc2Float(op, size, qd, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (mve_misc2_float_size_bits(*size) << 18)
                    | (qd.field() << 13)
                    | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveVmaxaMina(is_min, size, qda, qm) => split_instruction_word_into_halfwords(
                0xEE33_0E81
                    | ((*is_min as u32) << 12)
                    | (size.size_bits() << 18)
                    | (qda.field() << 13)
            ...
            .to_vec(),
            Self::MveVmaxnmaMinnma(is_min, size, qda, qm) => split_instruction_word_into_halfwords(
                0xEE3F_0E81
                    | ((*is_min as u32) << 12)
                    | (matches!(size, Arm32MveFloatSize::F16) as u32) << 28
                    | (qda.field() << 13)
                    | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveMvnRegister(qd, qm) => split_instruction_word_into_halfwords(
                MVE_VMVN_REG_BASE | (qd.field() << 13) | (qm.field() << 1),
            )
            .to_vec(),
            ...
            Self::MveGatherScatter(is_load, unsigned, esize, msize, scaled, qd, rn, qm) => {
                ...
                let word = MVE_GATHER_SCATTER_BASE
                    | ((*unsigned as u32) << 28)
                    | ((*is_load as u32) << 20)
                    | ((rn.as_operand_bits() as u32) << 16)
                    | (qd.field() << 13)
            ...
            Self::MveGatherScatterBase(is_load, is_dword, writeback, qd, qn, offset) => {
                ...
                let word = MVE_GATHER_VBASE_BASE
                    | ((*is_load as u32) << 20)
                    | ((*writeback as u32) << 21)
                    | (add << 23)
                    | ((*is_dword as u32) << 8)
            ...
            Self::LobEnd(tail_predicated, offset) => {
                ...
                split_instruction_word_into_halfwords((hw0 << 16) | lob_branch_hw1(*offset))
                    .to_vec()
            }
            ...
            Self::MveVctp(size, rn) => {
                ...
                split_instruction_word_into_halfwords(
                    MVE_VCTP_BASE | (size_bits << 20) | ((rn.as_operand_bits() as u32) << 16),
                )
                .to_vec()
            }

            // ---- MVE cross-lane reductions to a GPR ----
            Self::MveReduce(op, size, rd, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (size.size_bits() << 18)
                    | ((rd.as_operand_bits() as u32) << 12)
                    | (qm.field() << 1),
            ...
            Self::MveVrint(op, size, qd, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (mve_misc2_float_size_bits(*size) << 18)
                    | (qd.field() << 13)
                    | (qm.field() << 1),
            ...
            Self::MveVcvtFixed(to_fixed, unsigned, size, fbits, qd, qm) => {
                ...
                split_instruction_word_into_halfwords(
                    MVE_VCVT_FIXED_BASE
                        | ((*unsigned as u32) << 28)
                        | (imm6 << 16)
                        | ((matches!(size, Arm32MveFloatSize::F32) as u32) << 9)
                        | ((*to_fixed as u32) << 8)
                        | (qd.field() << 13)
                        | (qm.field() << 1),
                )
            ...
            Self::MveVshlc(shift, qda, rdm) => split_instruction_word_into_halfwords(
                MVE_VSHLC_BASE
                    | (((*shift as u32) & 0x1F) << 16)
                    | (qda.field() << 13)
                    | (rdm.as_operand_bits() as u32),
            )
            .to_vec(),
            ...
            Self::MveViddup(decrement, size, qd, rn, wrap_rm, step) => {
                ...
                split_instruction_word_into_halfwords(
                    MVE_VIDDUP_BASE
                        | (size.size_bits() << 20)
                        | (((rn.as_operand_bits() as u32) >> 1) << 17)
                        | (qd.field() << 13)
                        | ((*decrement as u32) << 12)
                        | (imm2 & 1)
                        | (((imm2 >> 1) & 1) << 7)
            ...
            Self::MveVbrsr(size, qd, qn, rm) => split_instruction_word_into_halfwords(
                MVE_VBRSR_BASE
                    | (size.size_bits() << 20)
                    | (qd.field() << 13)
                    | (qn.field() << 17)
            ...
            Self::MveVmovl(top, unsigned, size, qd, qm) => {
                let size_bit = if matches!(size, Arm32MveSize::I8) {
                    1u32 << 19
                } else {
                    1u32 << 20
                }; // .8 -> bit19, .16 -> bit20
            ...
            Self::MveVmovn(top, size, qd, qm) => {
                let size_bit = if matches!(size, Arm32MveSize::I32) {
                    1u32 << 18
                } else {
                    0
                }; // .16 -> 0, .32 -> bit18
            ...
            Self::MveVqdmull(top, size32, qd, qn, qm) => split_instruction_word_into_halfwords(
                MVE_VQDMULL_VEC_BASE
                    | ((*size32 as u32) << 28)
                    | ((*top as u32) << 12)
                    | (qd.field() << 13)
                    | (qn.field() << 17)
            ...
            Self::MveVshll(top, unsigned, size, shift, qd, qm) => {
                let esize: u32 = if matches!(size, Arm32MveSize::I16) {
                    16
                } else {
                    8
                };
            ...
            Self::Vmovx_T1(insert, sd, sm) => split_instruction_word_into_halfwords(
                MVE_VMOVX_BASE
                    | ((*insert as u32) << 7)
                    | (sd.extra_bit() << 22)
                    | (sd.field() << 12)
            ...
            .to_vec(),
            Self::Dbg_T1(option) => {
                split_instruction_word_into_halfwords(0xF3AF_80F0 | (*option as u32 & 0xF)).to_vec()
            }
            ...
            Self::Clrm_T1(list) => {
                split_instruction_word_into_halfwords(0xE89F_0000 | (*list as u32 & 0xDFFF))
                    .to_vec()
            }
            ...
            Self::Csel_T1(op, rd, rn, rm, cond) => split_instruction_word_into_halfwords(
                0xEA50_8000
                    ...
                    | ((*op as u32) << 12)
                    | ((rd.as_operand_bits() as u32) << 8)
                    | ((cond.as_operand_bits() as u32) << 4)
                    | (rm.as_operand_bits() as u32),
            )
            .to_vec(),
            Self::LongShiftImm_T1(op, rdalo, rdahi, imm) => split_instruction_word_into_halfwords(
                0xEA50_010F
                    | ((rdalo.as_operand_bits() as u32) << 16)
                    | (((rdahi.as_operand_bits() as u32 >> 1) & 0b111) << 9)
                    | (((*imm as u32 >> 2) & 0b111) << 12)
                    | ((*imm as u32 & 0b11) << 6)
                    | ((*op as u32) << 4),
            )
            .to_vec(),
            ...
            Self::SatShiftImm_T1(op, rda, imm) => split_instruction_word_into_halfwords(
                0xEA50_0F0F
                    | ((rda.as_operand_bits() as u32) << 16)
                    | (((*imm as u32 >> 2) & 0b111) << 12)
                    | ((*imm as u32 & 0b11) << 6)
                    | ((*op as u32) << 4),
            )
            .to_vec(),
            Self::SatShiftLongImm_T1(op, rdalo, rdahi, imm) => {
                split_instruction_word_into_halfwords(
                    0xEA51_010F
                        | (((rdalo.as_operand_bits() as u32 >> 1) & 0b111) << 17)
                        | (((rdahi.as_operand_bits() as u32 >> 1) & 0b111) << 9)
                        | (((*imm as u32 >> 2) & 0b111) << 12)
                        | ((*imm as u32 & 0b11) << 6)
                        | ((*op as u32) << 4),
            ...
            .to_vec(),
            Self::SatShiftLongReg_T1(signed, rdalo, rdahi, rm, sat48) => {
                split_instruction_word_into_halfwords(
                    0xEA51_010D
                        | (((rdalo.as_operand_bits() as u32 >> 1) & 0b111) << 17)
                        | (((rdahi.as_operand_bits() as u32 >> 1) & 0b111) << 9)
            ...
            .to_vec(),
            Self::Vcvt_Directed_FromSingle_T1(mode, sd, sm, signed) => {
                split_instruction_word_into_halfwords(
                    0xFEBC_0A40
                        | (mode.rm_bits() << 16)
                        | ((*signed as u32) << 7)
            ...
            Self::Vcvt_Directed_FromDouble_T1(mode, sd, dm, signed) => {
                split_instruction_word_into_halfwords(
                    0xFEBC_0B40
                        | (mode.rm_bits() << 16)
                        | ((*signed as u32) << 7)
            ...
            Self::MveVcaddFloat(size, rot270, qd, qn, qm) => split_instruction_word_into_halfwords(
                MVE_VCADD_FLOAT_PATTERN
                    | (if matches!(size, Arm32MveFloatSize::F32) {
                        1 << 20
                    } else {
                        0
                    })
            ...
            Self::MveVpsel(qd, qn, qm) => split_instruction_word_into_halfwords(
                MVE_VPSEL_BASE | (qn.field() << 17) | (qd.field() << 13) | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveVpnot => split_instruction_word_into_halfwords(MVE_VPNOT_WORD).to_vec(),

            // ---- MVE VCMP (compare into the VPR) ----
            Self::MveVcmpReg(cond, size, qn, qm) => split_instruction_word_into_halfwords(
                MVE_VCMP_INT_BASE
                    | (size.size_bits() << 20)
                    | mve_vcmp_fc_bits(*cond, false)
                    | (qn.field() << 17)
                    | (qm.field() << 1),
            )
            .to_vec(),
            Self::MveVcmpScalar(cond, size, qn, rm) => split_instruction_word_into_halfwords(
                MVE_VCMP_INT_BASE
                    | (1 << 6)
                    | (size.size_bits() << 20)
                    | mve_vcmp_fc_bits(*cond, true)
                    | (qn.field() << 17)
                    | (rm.as_operand_bits() as u32),
            )
            .to_vec(),
            Self::MveVcmpFloatReg(cond, size, qn, qm) => split_instruction_word_into_halfwords(
                MVE_VCMP_FLOAT_BASE
                    | (if matches!(size, Arm32MveFloatSize::F16) {
                        1 << 28
                    } else {
                        0
                    })
            ...
            .to_vec(),
            Self::MveVcmpFloatScalar(cond, size, qn, rm) => split_instruction_word_into_halfwords(
                MVE_VCMP_FLOAT_BASE
                    | (1 << 6)
                    | (if matches!(size, Arm32MveFloatSize::F16) {
                        1 << 28
            ...
            .to_vec(),
            Self::MveVpst(mask) => split_instruction_word_into_halfwords(
                MVE_VPST_NOT_BASE | mve_predicate_mask_bits(*mask),
            )
            .to_vec(),

            // ---- VPT (compare + predicate block) = VCMP | predicate-mask bits ----
            Self::MveVptReg(cond, size, qn, qm, mask) => split_instruction_word_into_halfwords(
                MVE_VCMP_INT_BASE
                    | (size.size_bits() << 20)
                    | mve_vcmp_fc_bits(*cond, false)
                    | (qn.field() << 17)
                    | (qm.field() << 1)
                    | mve_predicate_mask_bits(*mask),
            )
            .to_vec(),
            Self::MveVptScalar(cond, size, qn, rm, mask) => split_instruction_word_into_halfwords(
                MVE_VCMP_INT_BASE
                    | (1 << 6)
                    | (size.size_bits() << 20)
                    | mve_vcmp_fc_bits(*cond, true)
            ...
            Self::MveFloatReduce(op, size, rd, qm) => split_instruction_word_into_halfwords(
                op.base_word()
                    | (if matches!(size, Arm32MveFloatSize::F16) {
                        1 << 28
                    } else {
    ...
    pub fn requirement(&self) -> ArmInstructionRequirement {
        match self {
            ...
            | Self::Smmul_T1(..)
            | Self::Smmla_T1(..)
            | Self::Smmls_T1(..) => ArmInstructionRequirement::new(
            ...
            | Self::Vcvt_FixedToFloat_Double_T1(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv7M,
            ...
            Self::Vlstm_T1(..) | Self::Vlldm_T1(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8MMainline,
                &[ArmCpuFeature::Security, ArmCpuFeature::FloatingPoint],
            ),
            ...
            Self::MveIntArith(..)
            | Self::MveBitwise(..)
            | Self::MveVecScalarInt(..)
            | Self::MveVdup(..)
            | Self::MveShiftImm(..)
            | Self::MveMisc2(..)
            | Self::MveMvnRegister(..)
            | Self::MveLoadStore(..)
            | Self::MveGatherScatter(..)
            | Self::MveGatherScatterBase(..)
            | Self::MveInterleave(..)
            | Self::MveReduce(..)
            | Self::MveVabav(..)
            | Self::MveDualMac(..)
            ...
            | Self::MveVmulh(..)
            | Self::MveVqdmull(..)
            | Self::MveVqdmullScalar(..)
            | Self::MveVqdmladh(..)
            | Self::MveShiftByVector(..)
            | Self::MveShiftByScalar(..)
            | Self::MveVshll(..)
            | Self::MveVcaddInt(..)
            | Self::MveVpsel(..)
            | Self::MveVpnot
            ...
            | Self::MveVptScalar(..)
            | Self::MveVmaxaMina(..)
            | Self::MveVmovTwoLane(..) => ArmInstructionRequirement::new(
            ...
            | Self::MveVcmul(..)
            | Self::MveVcmla(..)
            | Self::MveVcmpFloatReg(..)
            | Self::MveVcmpFloatScalar(..)
            | Self::MveVptFloatReg(..)
            | Self::MveVptFloatScalar(..)
            | Self::MveFloatReduce(..)
            | Self::MveVcvtRound(..)
            | Self::MveVcvtFixed(..)
            | Self::MveVcvtHalf(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve, ArmCpuFeature::MveFloat],
            ),
            Self::MveMisc2Float(..) | Self::MveVmaxnmaMinnma(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve, ArmCpuFeature::MveFloat],
            ),
            Self::MveFloatArith(..)
            | Self::MveVecScalarFloat(..)
            | Self::MveVrint(..)
            | Self::MveVcvtFloatInt(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve, ArmCpuFeature::MveFloat],
            ),
            // the modified immediate is integer MVE, except VMOV.f32 (cmode 0b1111, op=0) which needs MVE FP.
            Self::MveModifiedImmediate(0b1111, false, _, _) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve, ArmCpuFeature::MveFloat],
            ),
            Self::MveModifiedImmediate(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve],
            ),
            ...
            Self::LobStart(_, Some(_), _, _)
            | Self::LobEnd(true, _)
            | Self::Lctp
            | Self::MveVctp(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve],
            ),
            ...
            Self::Vmovx_T1(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::FloatingPoint],
            ),
            // ARMv8-M load-acquire / store-release (LDA/STL + exclusive variants).
            Self::LoadAcquire_T1(..)
            | Self::StoreRelease_T1(..)
            | Self::StoreReleaseExclusive_T1(..) => {
            ...
            | Self::Coproc_Cdp_T1(..)
            | Self::Coproc_Mcrr_T1(..)
            | Self::Coproc_Ldc_T1(..) => ArmInstructionRequirement::new(ArmIsaVersion::Armv7M, &[]),
            ...
            Self::Vscclrm_T1(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::FloatingPoint],
            ),
            ...
            // HLT and SETPAN are A-profile Thumb instructions (HLT = ARMv8-A halting debug; SETPAN = FEAT_PAN,
            // ARMv8.1-A) -- NOT M-profile, and with no finer A-profile-Thumb gate in the M-lineage model, exactly
            // like SB / VJCVT above. Both gate at the earliest ARMv8 rank; profile validity is enforced by the
            // oracle's march (armv8.1-a -mthumb), not the version alone -- so, like SB/VJCVT, these are unit-tested.
            Self::Hlt_T1(..) | Self::Setpan_T1(..) => {
                ArmInstructionRequirement::new(ArmIsaVersion::Armv8MBaseline, &[])
            }
            Self::Vsel_Single_T1(..)
            | Self::Vsel_Double_T1(..)
            | Self::Vrintr_Single_T1(..)
            | Self::Vrintr_Double_T1(..)
            | Self::Vmaxnm_Single_T1(..)
            | Self::Vmaxnm_Double_T1(..)
            | Self::Vminnm_Single_T1(..)
            | Self::Vminnm_Double_T1(..)
            | Self::Vrint_Directed_Single_T1(..)
            | Self::Vrint_Directed_Double_T1(..)
            | Self::Vrintz_Single_T1(..)
            | Self::Vrintz_Double_T1(..)
            ...
            | Self::Vcvt_Directed_FromDouble_T1(..)
            | Self::Vjcvt_T1(..) =>
            // VJCVT needs FEAT_JSCVT; no finer gate in the model than the v8-M FP group.
            {
                ArmInstructionRequirement::new(
                    ArmIsaVersion::Armv8MBaseline,
                    &[ArmCpuFeature::FloatingPoint],
            ...
            Self::LongShiftImm_T1(..)
            | Self::LongShiftReg_T1(..)
            | Self::SatShiftImm_T1(..)
            | Self::SatShiftLongImm_T1(..)
            | Self::SatShiftReg_T1(..)
            | Self::SatShiftLongReg_T1(..) => ArmInstructionRequirement::new(
                ArmIsaVersion::Armv8_1MMainline,
                &[ArmCpuFeature::Mve],
            ),
    ...
    pub fn vpt_block_member_suffixes(&self) -> Option<Vec<char>> {
        let mask = match self {
            ...
            Self::MveVptReg(.., mask)
            | Self::MveVptScalar(.., mask)
            | Self::MveVptFloatReg(.., mask)
            | Self::MveVptFloatScalar(.., mask) => *mask,
            _ => return None,
        };
    ...
    pub fn encode_for_target(
        &self,
        target_profile: &ArmTargetProfile,
    ...
    I: Iterator<Item = &'a u8>,
{
    ...
    *iter_offset += 1;
    ...
    let byte1 = match iter.next() {
        ...
        } // could not capture second byte (out of 2) of word
    };
    *iter_offset += 1;
...
fn check_general_register_is_encodable(
    field: &'static str,
    register: &Arm32GeneralPurposeRegister,
) -> Result<(), EncodeError> {
    match register {
        Arm32GeneralPurposeRegister::R13 => Err(EncodeError::RegisterNotEncodable {
            field,
            detail: "SP (R13) is not permitted in this ARMv7-M operand",
        }),
        Arm32GeneralPurposeRegister::R15 => Err(EncodeError::RegisterNotEncodable {
            field,
...
fn check_register_is_not_pc(
    ...
    if *register == Arm32GeneralPurposeRegister::R15 {
        Err(EncodeError::RegisterNotEncodable {
            field,
            detail: "PC (R15) base selects the literal form; use a register base here",
        })
    } else {
        Ok(())
    }
...
fn encode_data_processing_modified_immediate(
    op4: u32,
    set_flags: bool,
    rn: u8,
    rd: u8,
    ...
    let imm12 =
        encode_thumb_expand_imm(value).ok_or(EncodeError::ModifiedImmediateNotEncodable {
            field: "const",
            value,
        })?;
...
fn encode_data_processing_shifted_register(
    op4: u32,
    set_flags: bool,
    rn: u8,
    rd: u8,
...
fn encode_dp_shifted_register(
    ...
    check_general_register_is_encodable("rn", rn)?;
    check_general_register_is_encodable("rm", rm)?;
    let word = encode_data_processing_shifted_register(
        op4,
        set_flags,
        rn.as_operand_bits(),
        rd.as_operand_bits(),
...
fn encode_load_store_immediate12(
    base: u32,
    rt: &Arm32GeneralPurposeRegister,
    rn: &Arm32GeneralPurposeRegister,
    imm12: u16,
...
fn encode_long_multiply(
    ...
    let word = base
        | ((rn.as_operand_bits() as u32) << 16)
        | ((rdlo.as_operand_bits() as u32) << 12)
        | ((rdhi.as_operand_bits() as u32) << 8)
        | (rm.as_operand_bits() as u32);
    Ok(split_instruction_word_into_halfwords(word).to_vec())
}
...
fn encode_extend(
    ...
    let word =
        base | ((rd.as_operand_bits() as u32) << 8) | (rotate << 4) | (rm.as_operand_bits() as u32);
    Ok(split_instruction_word_into_halfwords(word).to_vec())
}
...
fn encode_saturate(
    ...
    let (sh, amount) = match shift {
        ...
        _ => {
            return Err(EncodeError::ShiftNotEncodable {
                field: "shift",
                detail: "SSAT/USAT allow only LSL or ASR",
            });
        }
    };
...
fn decode_word_saturate(
    ...
    let shift = if sh == 0 {
        ...
        ArmT32RegisterShift::Asr(amount)
    };
    (rd, sat_imm, rn, shift)
}
...
fn decode_word_load_store_indexed(
    word: u32,
) -> Option<(
    /*rt*/ u8,
    /*rn*/ u8,
...
fn encode_load_store_dual(
    ...
    let word = 0xE840_0000
        ...
        | ((rn.as_operand_bits() as u32) << 16)
        | ((rt.as_operand_bits() as u32) << 12)
        | ((rt2.as_operand_bits() as u32) << 8)
        | imm8;
    Ok(split_instruction_word_into_halfwords(word).to_vec())
}

fn decode_word_load_store_dual(
    word: u32,
) -> Option<(
    /*rt*/ u8,
    /*rt2*/ u8,
...
fn encode_load_store_multiple(
    base: u32,
    is_load: bool,
    rn: &Arm32GeneralPurposeRegister,
    writeback: bool,
    registers: &[Arm32GeneralPurposeRegister],
) -> Result<Vec<u16>, EncodeError> {
    check_register_is_not_pc("rn", rn)?;
    if registers.is_empty() {
        return Err(EncodeError::RegisterNotEncodable {
            field: "registers",
            detail: "the register list must not be empty",
        });
    }
    ...
    if list & (1 << 13) != 0 {
        return Err(EncodeError::RegisterNotEncodable {
            field: "registers",
            detail: "SP (R13) is not permitted in a load/store-multiple register list",
        });
    }
    if !is_load && (list & (1 << 15) != 0) {
        return Err(EncodeError::RegisterNotEncodable {
            field: "registers",
            detail: "PC (R15) is not permitted in a store-multiple register list",
        });
    }
...
fn decode_word_load_store_multiple(
    word: u32,
) -> (
    /*rn*/ u8,
    /*writeback*/ bool,
    ...
    let rn = ((word >> 16) & 0b1111) as u8;
    let registers =
        gpr_coding_utils::convert_gpr_register_list_u16_to_registers_vector((word & 0xFFFF) as u16);
...
fn encode_branch_wide_conditional(
    cond: &ArmT32InstructionCondition,
    offset: i32,
) -> Result<Vec<u16>, EncodeError> {
    if *cond == ArmT32InstructionCondition::AlwaysUnconditional {
        return Err(EncodeError::ConditionNotEncodable {
            field: "cond",
            detail: "the AL condition is not encodable in B<c>.W T3; use B.W instead",
        });
    }
    if *cond == ArmT32InstructionCondition::Undefined(0b1111) {
        return Err(EncodeError::ConditionNotEncodable {
            field: "cond",
            detail: "the 0b1111 condition is not encodable in B<c>.W T3",
        });
    }
    check_multiple_of("offset", offset as i64, 2)?;
    ...
    let word = 0xF000_8000
        | (s << 26)
        | ((cond.as_operand_bits() as u32) << 22)
        | (imm6 << 16)
        | (j1 << 13)
        | (j2 << 11)
        | imm11;
...
fn encode_compare_branch(
    base: u32,
    rn: &Arm32LowGeneralPurposeRegister,
    offset: u8,
) -> Result<Vec<u16>, EncodeError> {
...
fn encode_saturating_arithmetic(
    base: u32,
    rd: &Arm32GeneralPurposeRegister,
    rm: &Arm32GeneralPurposeRegister,
    rn: &Arm32GeneralPurposeRegister,
...
fn encode_signed_multiply_accumulate(
    base: u32,
    rd: &Arm32GeneralPurposeRegister,
    rn: &Arm32GeneralPurposeRegister,
    rm: &Arm32GeneralPurposeRegister,
...
fn encode_signed_multiply_long(
    base: u32,
    rdlo: &Arm32GeneralPurposeRegister,
    rdhi: &Arm32GeneralPurposeRegister,
    rn: &Arm32GeneralPurposeRegister,
...
fn encode_fp_load_store_multiple(
    size_low: u32,
    is_load: bool,
    rn: &Arm32GeneralPurposeRegister,
    writeback: bool,
    ...
    if count == 0 || (first_number as u32) + (count as u32) - 1 > max_register as u32 {
        return Err(EncodeError::ImmediateOutOfRange {
            ...
            value: count as i64,
            minimum: 1,
            maximum: (max_register as i64) - (first_number as i64) + 1,
        });
    }
    if decrement_before && !writeback {
        return Err(EncodeError::RegisterNotEncodable {
            field: "rn",
            detail: "the decrement-before (DB) form requires writeback (!)",
        });
    }
    let p = if decrement_before { 1u32 } else { 0 };
    let u = if decrement_before { 0u32 } else { 1 };
    let imm8 = if is_double {
        (count as u32) * 2
    } else {
        count as u32
    };
    let word = 0xEC00_0000
        | size_low
        | (p << 24)
        | (u << 23)
        | (d_bit << 22)
...
fn decode_word_fp_load_store_multiple(
    word: u32,
) -> (
    /*rn*/ u8,
    /*writeback*/ bool,
...
fn vcx_enc_imm1(imm: u16) -> u32 {
    let i = imm as u32;
    (i & 0x3F) | (((i >> 6) & 1) << 7) | (((i >> 7) & 0xF) << 16)
}
fn vcx_dec_imm1(w: u32) -> u16 {
    ((w & 0x3F) | (((w >> 7) & 1) << 6) | (((w >> 16) & 0xF) << 7)) as u16
}
fn vcx_enc_imm2(imm: u8) -> u32 {
    let i = imm as u32;
    ((i & 1) << 4) | (((i >> 1) & 1) << 7) | (((i >> 2) & 0xF) << 16)
}
fn vcx_dec_imm2(w: u32) -> u8 {
    (((w >> 4) & 1) | (((w >> 7) & 1) << 1) | (((w >> 16) & 0xF) << 2)) as u8
}
fn vcx_enc_imm3(imm: u8) -> u32 {
    let i = imm as u32;
    ((i & 1) << 4) | (((i >> 1) & 1) << 20) | (((i >> 2) & 1) << 21)
}
fn vcx_dec_imm3(w: u32) -> u8 {
    (((w >> 4) & 1) | (((w >> 20) & 1) << 1) | (((w >> 21) & 1) << 2)) as u8
}
